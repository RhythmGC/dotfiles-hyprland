...
echo "=== BlueArchive AUR Publication Helper ==="
echo ""
...
if ! ssh -T aur@aur.archlinux.org -o ConnectTimeout=5 2>&1 | grep -q "Welcome"; then
    ...
    echo "  2. Go to https://aur.archlinux.org/account/RhythmGC/edit"
...
if ! curl -sf "https://raw.githubusercontent.com/RhythmGC/dotfiles-hyprland/dev/LICENSE" >/dev/null 2>&1; then
