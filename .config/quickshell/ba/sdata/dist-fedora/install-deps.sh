# Install dependencies for BlueArchive on Fedora-based systems
...
# Material Symbols Rounded (icons) - this is the font BlueArchive actually uses
...
# Geist (used by default in BlueArchive)
