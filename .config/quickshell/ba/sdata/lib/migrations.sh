# Migration system for BlueArchive
...
_ba_config_dir="${XDG_CONFIG_HOME:-$HOME/.config}/baOS"

MIGRATIONS_STATE_FILE="${_ba_config_dir}/migrations.json"
MIGRATIONS_BACKUP_DIR="${_ba_config_dir}/backups"
