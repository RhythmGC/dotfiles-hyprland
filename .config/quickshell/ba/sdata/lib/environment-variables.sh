# Environment variables for BlueArchive installer
...
BACKUP_DIR="${BACKUP_DIR:-$HOME/ba-backup}"
resolve_ba_config_dir() {
  printf '%s/baOS' "$XDG_CONFIG_HOME"
}

DOTS_CORE_CONFDIR="${DOTS_CORE_CONFDIR:-$(resolve_ba_config_dir)}"
