...
migration_preview() {
  echo -e "${STY_GREEN}+ XF86AudioPlay { spawn \"ba\" \"mpris\" \"playPause\"; }${STY_RST}"
  echo -e "${STY_GREEN}+ XF86AudioPause { spawn \"ba\" \"mpris\" \"playPause\"; }${STY_RST}"
  echo -e "${STY_GREEN}+ XF86AudioNext { spawn \"ba\" \"mpris\" \"next\"; }${STY_RST}"
  echo -e "${STY_GREEN}+ XF86AudioPrev { spawn \"ba\" \"mpris\" \"previous\"; }${STY_RST}"
}
...
if insert_idx is not None:
    ...
    XF86AudioPlay { spawn "ba" "mpris" "playPause"; }
    XF86AudioPause { spawn "ba" "mpris" "playPause"; }
    XF86AudioNext { spawn "ba" "mpris" "next"; }
    XF86AudioPrev { spawn "ba" "mpris" "previous"; }
'''
