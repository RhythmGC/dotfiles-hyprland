...
MIGRATION_DESCRIPTION="Replaces Mod+Q close-window with BlueArchive's closeConfirm script.
...
migration_preview() {
  ...
  echo -e "${STY_GREEN}+ Mod+Q { spawn \"ba\" \"close-window\"; }${STY_RST}"
}
...
replacement = 'Mod+Q repeat=false { spawn "ba" "close-window"; }'
