...
migration_apply() {
  local ba_dir
  ba_dir="$(get_runtime_shell_dir)"
  ba_dir="${ba_dir:-${XDG_CONFIG_HOME:-$HOME/.config}/quickshell/ba}"
  local gtk4_src="${ba_dir}/dots/.config/matugen/templates/gtk-4.0/gtk.css"
  local gtk4_dst="${XDG_CONFIG_HOME:-$HOME/.config}/matugen/templates/gtk-4.0/gtk.css"
  local gtk3_src="${ba_dir}/dots/.config/matugen/templates/gtk-3.0/gtk.css"
