...
MIGRATION_DESCRIPTION="Adds XF86MonBrightnessUp/Down keybinds that use BlueArchive IPC.
...
migration_preview() {
  echo -e "${STY_GREEN}+ XF86MonBrightnessUp { spawn \"ba\" \"brightness\" \"increment\"; }${STY_RST}"
  echo -e "${STY_GREEN}+ XF86MonBrightnessDown { spawn \"ba\" \"brightness\" \"decrement\"; }${STY_RST}"
}
...
if insert_idx is not None:
    ...
    XF86MonBrightnessUp { spawn "ba" "brightness" "increment"; }
    XF86MonBrightnessDown { spawn "ba" "brightness" "decrement"; }
'''
