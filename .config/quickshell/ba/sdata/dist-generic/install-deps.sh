# Generic dependency installation guide for BlueArchive
...
echo -e "${STY_CYAN}║           BlueArchive - Generic Installation Guide                      ║${STY_RST}"
echo -e "${STY_CYAN}╚══════════════════════════════════════════════════════════════════╝${STY_RST}"
echo ""
...
echo "  - https://github.com/RhythmGC/dotfiles-hyprland/wiki/Manual-Installation"
