// YouTube Music AdBlock userscript for BlueArchive WebEngine
...
(function() {
    ...
    const LOG_PREFIX = '[BlueArchive-AdBlock]';
    ...
    function muteAdAudio() {
        ...
        if (player.classList.contains('ad-showing')) {
            if (!video.muted) {
                video.muted = true;
                video.dataset.baMuted = 'true';
            }
        } else if (video.dataset.baMuted === 'true') {
            video.muted = false;
            delete video.dataset.baMuted;
        }
    }
