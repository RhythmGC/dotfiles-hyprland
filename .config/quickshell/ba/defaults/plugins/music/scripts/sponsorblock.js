// SponsorBlock userscript for BlueArchive WebEngine
...
(function() {
    ...
    const LOG_PREFIX = '[BlueArchive-SponsorBlock]';
    ...
    function showSkipNotification(category) {
        ...
        const existing = document.getElementById('ba-sb-notification');
