...
//@ pragma Env BA_STANDALONE_WINDOW=1
...
Scope {
    ...
    Timer {
        ...
        onTriggered: {
            ...
            Quickshell.execDetached(["/usr/bin/notify-send", Translation.tr("Welcome to ba"), Translation.tr("Press Super+/ for all keyboard shortcuts."), "-a", "Shell"])
            Qt.quit()
        }
    }
    ...
    PanelWindow {
        ...
        Item {
            ...
            Rectangle {
                ...
                radius: Appearance.baEverywhere ? Appearance.ba.roundingLarge
                ...
                color: Appearance.baEverywhere ? Appearance.ba.colLayer1
                     : Appearance.auroraEverywhere ? "transparent"
                     : Appearance.colors.colLayer1Base

                border.width: Appearance.baEverywhere ? 1 : (Appearance.auroraEverywhere ? 0 : 1)
                border.color: Appearance.baEverywhere ? Appearance.ba.colBorder
    ...
    component WelcomeContent: ColumnLayout {
        ...
        StyledText {
            Layout.alignment: Qt.AlignHCenter
            text: Translation.tr("Welcome to ba")
            font.family: Appearance.font.family.title
        ...
        Rectangle {
            ...
            radius: Appearance.baEverywhere ? Appearance.ba.roundingNormal : Appearance.rounding.normal
            ...
            border.color: Appearance.ba.colBorderSubtle
            ...
            RowLayout {
                ...
                Rectangle {
                    ...
                    border.color: selected
                        ...
                        : (Appearance.baEverywhere ? Appearance.ba.colBorderSubtle
                          : Appearance.colors.colLayer0Border)
                ...
                Rectangle {
                    ...
                    ColumnLayout {
                        ...
                        StyledText {
                            Layout.fillWidth: true
                            text: Translation.tr("Everything BlueArchive has to offer. Recommended if you like to tinker.")
                            font.pixelSize: Appearance.font.pixelSize.smaller
                            wrapMode: Text.WordWrap
                            color: advancedCard.selected
                                ? Appearance.colors.colOnPrimaryContainer
            ...
            ColumnLayout {
                ...
                ConfigSelectionArray {
                    ...
                    options: [
                        ...
                        { displayName: "Ba", icon: "terminal", value: "ba" }
                    ]
                }
            }
        }
        ...
        GridLayout {
            ...
            SettingsGroup {
                ...
                ColumnLayout {
                    ...
                    ConfigSelectionArray {
                        Layout.fillWidth: true
                        currentValue: Config.options?.panelFamily ?? "ba"
                        onSelected: v => Config.setNestedValue("panelFamily", v)
                        options: [
                            { displayName: "Material BA", icon: "dashboard", value: "ba" },
    ...
    component ReadyContent: Flickable {
        ...
        ColumnLayout {
                        ...
                        Repeater {
                            ...
                            RippleButton {
                                ...
                                onClicked: Quickshell.execDetached([
                                    Quickshell.shellPath("scripts/ba"),
                                    modelData.target,
                                    modelData.fn
                                ])
            ...
            RippleButton {
                ...
                buttonRadius: Appearance.baEverywhere ? Appearance.ba.roundingNormal : Appearance.rounding.normal
                ...
                onClicked: Qt.openUrlExternally("https://github.com/RhythmGC/dotfiles-hyprland/wiki/Troubleshooting")
            ...
            RowLayout {
                ...
                RippleButton {
                    ...
                    RowLayout {
                        ...
                        StyledText { text: Translation.tr("BlueArchive Wiki"); font.pixelSize: Appearance.font.pixelSize.small }
                    }
                }
                ...
                RippleButton {
                    ...
                    colBackground: Appearance.colors.colLayer2
                    colBackgroundHover: Appearance.colors.colLayer2Hover
                    onClicked: Qt.openUrlExternally("https://github.com/RhythmGC/dotfiles-hyprland")
                    RowLayout {
                        anchors.centerIn: parent
                        spacing: 8
