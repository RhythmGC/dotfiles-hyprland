...
func main() {
	...
	defaultOutput := filepath.Join(home, ".config/zed/themes/ba-theme.json")
	...
	// Keep default BlueArchive border tones aligned with the BlueArchive-alt border palette.
	...
	themeData := map[string]any{
		...
		"name":    "BlueArchive Material",
		"author":  "BlueArchive Theme System",
		"themes": []any{
			map[string]any{"name": "BlueArchive Dark", "appearance": "dark", "style": darkStyle},
			map[string]any{"name": "BlueArchive Light", "appearance": "light", "style": lightStyle},
			map[string]any{"name": "BlueArchive Borderless Dark", "appearance": "dark", "style": makeBorderlessStyle(darkStyle)},
			map[string]any{"name": "BlueArchive Borderless Light", "appearance": "light", "style": makeBorderlessStyle(lightStyle)},
			map[string]any{"name": "BlueArchive-alt Dark", "appearance": "dark", "style": altDark},
			map[string]any{"name": "BlueArchive-alt Light", "appearance": "light", "style": altLight},
		},
	}
