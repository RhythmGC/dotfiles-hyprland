...
# from BlueArchive Material colors using custom theme with live updates.
#
# Design:
...
# Writes: ~/.config/spicetify/Themes/Ba/color.ini
#         ~/.config/spicetify/Themes/Ba/user.css  (bridge block only)
...
regenerate_user_css_bridge() {
  ...
  local bridge_block
  bridge_block="/* === BlueArchive CSS variable bridge - auto-generated, do not edit === */
:root {
...
/* === end BlueArchive CSS variable bridge === */"
...
pattern = re.compile(
    r'/\* === BlueArchive CSS variable bridge - auto-generated, do not edit === \*/.*?/\* === end BlueArchive CSS variable bridge === \*/\n?',
    re.DOTALL
)
...
regenerate_playback_controls_fix() {
  ...
  playback_block="/* === BlueArchive playback controls fix - auto-generated === */
...
/* === end BlueArchive playback controls fix === */"
...
content = css_path.read_text()
pattern = re.compile(
    r'/\* === BlueArchive playback controls fix - auto-generated === \*/.*?(?=(/\* === end BlueArchive playback controls fix === \*/|/\* === BlueArchive playback controls fix - auto-generated === \*/|\Z))',
    re.DOTALL
)
content = pattern.sub('', content)
content = re.sub(r'/\* === end BlueArchive playback controls fix === \*/\n?', '', content)
