...
ZED_THEMEGEN_BIN="$STATE_DIR/user/generated/bin/ba-zed-themegen"
ZED_THEMEGEN_SRC="$SCRIPT_DIR/zed_themegen/main.go"
ZED_OUTPUT_FILE="$HOME/.config/zed/themes/ba-theme.json"
...
ensure_zed_themegen() {
  ...
  local tmp_bin="$STATE_DIR/user/generated/bin/.ba-zed-themegen.$$"
