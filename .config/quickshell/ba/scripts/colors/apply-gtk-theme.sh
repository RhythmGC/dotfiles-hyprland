#!/usr/bin/env bash
set -euo pipefail
# Apply Qt/KDE/GTK theme colors from BlueArchive's generated palette contract.
# Generates:
...
generate_pywalfox() {
    # Generate pywalfox-compatible JSON from BlueArchive palette for Firefox theming
...
cat > "$GTK3_CSS" << EOF
/*
 * GTK Colors - Generated with BlueArchive theming
...
cat > "$GTK4_CSS" << EOF
/*
 * GTK4/libadwaita Colors — Generated by BlueArchive theming
