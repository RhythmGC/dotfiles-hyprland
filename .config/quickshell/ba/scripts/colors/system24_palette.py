...
MIDNIGHT_OUTPUT_FILE = Path(
    os.environ.get(
        "MIDNIGHT_DMS_CSS",
        "~/.config/vesktop/themes/ba-midnight.theme.css",
    )
).expanduser()
 ...
 * @author refact0r (system24 base), BlueArchive (Material adaptation)
 * @version 2.2.0
 * @source https://github.com/RhythmGC/dotfiles-hyprland
 */
 ...
 * @name BlueArchive Midnight
 * @description BlueArchive Midnight Discord theme with Material You colors.
 * @author BlueArchive (Material palette injection)
 * @version 2.2.0
 * @source https://github.com/RhythmGC/dotfiles-hyprland
 */
...
def _write_palette(palette: Dict[str, str]) -> None:
    ...
    for out in midnight_outputs:
        ...
        legacy_out = out.parent / "ba-midnight.theme.css"
        if legacy_out != out:
