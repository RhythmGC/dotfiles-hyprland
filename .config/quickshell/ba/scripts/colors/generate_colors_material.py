#!/usr/bin/env -S\_/bin/sh\_-c\_"source\_\$(eval\_echo\_\${BA_VENV:-\$BA_VENV_COMPAT})/bin/activate&&exec\_python\_-E\_"\$0"\_"\$@""
import argparse
import math
import json
import os
...
# ---------------------------------------------------------------------------
# Template rendering for BlueArchive's unified theming pipeline
# ---------------------------------------------------------------------------
if args.render_templates:
    ...
    sddm_theme = "/usr/share/sddm/themes/ba-pixel"
