...
def generate_zed_config(
    ...
    theme_data = {
        ...
        "themes": [
            {"name": "BlueArchive Dark", "appearance": "dark", "style": dark_style},
            {"name": "BlueArchive Light", "appearance": "light", "style": light_style},
            {
                "name": "BlueArchive Borderless Dark",
                "appearance": "dark",
                "style": borderless_dark_style,
            },
            {
                "name": "BlueArchive Borderless Light",
                "appearance": "light",
                "style": borderless_light_style,
            },
            {"name": "BlueArchive-alt Dark", "appearance": "dark", "style": alt_dark_style},
            {
                "name": "BlueArchive-alt Light",
                "appearance": "light",
