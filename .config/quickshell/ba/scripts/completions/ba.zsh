#compdef ba
# Zsh completion for ba CLI
# Install: eval "$(ba completions zsh)"
# Or: ba completions zsh > ~/.zsh/completions/_ba
...
_ba() {
    ...
    if _ba_load_registry 2>/dev/null; then
        local t
