#!/usr/bin/env bash
# Memory optimization environment for Quickshell/BlueArchive
#
...
#     source ~/.config/quickshell/ba/scripts/quickshell-env.sh
#     ba run
#
...
# Match ba.service: let the launcher control restarts after a Qt shutdown crash.
