#!/usr/bin/env python3
"""Add a plugin to the BlueArchive plugin directory.
...
def resolve_shell_config_dir() -> str:
    ...
    new_dir = os.path.join(xdg_config, "baOS")
    legacy_dir = os.path.join(xdg_config, "baOS")
...
def main():
    parser = argparse.ArgumentParser(
        description="Add a web plugin to the BlueArchive plugin directory."
    )
