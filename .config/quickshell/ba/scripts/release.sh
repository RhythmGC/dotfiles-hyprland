...
Update: https://github.com/RhythmGC/dotfiles-hyprland?tab=readme-ov-file#update
Fresh install: https://github.com/RhythmGC/dotfiles-hyprland?tab=readme-ov-file#install
Full changelog: https://github.com/RhythmGC/dotfiles-hyprland/blob/main/.config/quickshell/ba/CHANGELOG.md
EOF
}
