...
declare -gA IPC_TARGET_DESC=(
  ...
  [customWidgets]="Custom widget management. Create, list, reload, and remove user-installed widgets from \`~/.config/baOS/widgets/\`."
  ...
  [panelFamily]="Switch between panel styles. ba supports two visual styles: Material ba (default) and Waffle (Windows 11-like)."
  ...
  [settingsNav]="Navigate the settings overlay to a specific page (same as clicking the nav rail). Opening the window itself is the \`ba settings\` CLI command (target \`settings\` above)."
  ...
  [waffleAltSwitcher]="Waffle Alt+Tab window switcher. Separate from the ba \`altSwitcher\` — supports quick-switch (first tab switches instantly, second opens UI) and no-visual-UI mode."
...
declare -gA IPC_FUNCTION_DESC=(
  ...
  ["panelFamily:cycle"]="Cycle to next panel family (ba → waffle → ba)"
  ["panelFamily:set"]="Set specific family (\"ba\" or \"waffle\")"
...
declare -gA IPC_TARGET_EXAMPLE=(
  [altSwitcher]='bind "Alt+Tab" { spawn "ba" "altSwitcher" "next"; }
bind "Alt+Shift+Tab" { spawn "ba" "altSwitcher" "previous"; }'
  [background]='bind "Super+W" { spawn "ba" "background" "toggleEditMode"; }'
  [cheatsheet]='bind "Super+Slash" { spawn "ba" "cheatsheet" "toggle"; }'
  [clipboard]='bind "Super+V" { spawn "ba" "clipboard" "toggle"; }'
  [closeConfirm]='bind "Mod+Q" repeat=false { spawn "ba" "close-window"; }'
  [coverflowSelector]='bind "Ctrl+Alt+T" { spawn "ba" "coverflowSelector" "toggle"; }'
  [gamemode]='bind "Super+F12" { spawn "ba" "gamemode" "toggle"; }'
  [globalActions]='bind "Super+Slash" { spawn "ba" "globalActions" "open"; }
bind "Super+M" { spawn "ba" "globalActions" "run" "toggle-mute"; }'
  [idle]='bind "Super+Shift+I" { spawn "ba" "idle" "toggle"; }'
  [keyboard]='bind "Mod+Alt+K" { spawn "ba" "keyboard" "switchLayout"; }'
  [lock]='bind "Super+Alt+L" allow-when-locked=true { spawn "ba" "lock" "activate"; }'
  [mpris]='bind "Ctrl+Mod+Space" { spawn "ba" "mpris" "playPause"; }
bind "Mod+Alt+N" { spawn "ba" "mpris" "next"; }
bind "Mod+Alt+P" { spawn "ba" "mpris" "previous"; }'
  [overlay]='bind "Super+G" { spawn "ba" "overlay" "toggle"; }'
  [overview]='bind "Mod+Space" { spawn "ba" "overview" "toggle"; }'
  [panelFamily]='bind "Mod+Shift+W" { spawn "ba" "panelFamily" "cycle"; }'
  [region]='bind "Super+Shift+S" { spawn "ba" "region" "screenshot"; }
bind "Super+Shift+X" { spawn "ba" "region" "ocr"; }
bind "Super+Shift+A" { spawn "ba" "region" "search"; }'
  [session]='bind "Super+Shift+E" { spawn "ba" "session" "toggle"; }'
  [settings]='bind "Super+Comma" { spawn "ba" "settings"; }'
  [voiceSearch]='bind "Super+Shift+V" { spawn "ba" "voiceSearch" "toggle"; }'
  [wallpaperSelector]='bind "Ctrl+Alt+T" { spawn "ba" "wallpaperSelector" "toggle"; }'
  [ytmusic]='bind "Mod+M+Space" { spawn "ba" "ytmusic" "playPause"; }'
)
