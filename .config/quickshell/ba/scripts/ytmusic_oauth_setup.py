#!/usr/bin/env python3
"""
YouTube Music OAuth Setup for BlueArchive
...
def banner():
    print(f"""
{CYAN}{B}╔══════════════════════════════════════════════════════╗
║         BlueArchive — YouTube Music OAuth Setup             ║
╚══════════════════════════════════════════════════════╝{R}
""")
...
def main():
    ...
    print(f"""{B}This wizard will set up OAuth so BlueArchive can like/unlike songs
...
""")
  ...
  2. Name it anything (e.g. "ba-ytmusic")
  3. Click {B}Create{R}
...
""")
  ...
  3. App name: anything (e.g. "BlueArchive")
