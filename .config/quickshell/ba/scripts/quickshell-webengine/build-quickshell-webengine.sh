...
# for BlueArchive's WebApp plugin system. For Arch Linux users, prefer the PKGBUILD
...
echo "═══════════════════════════════════════════════════"
echo "  Quickshell + WebEngine build for BlueArchive"
echo "═══════════════════════════════════════════════════"
...
cmake -B build -G Ninja \
    ...
    -DDISTRIBUTOR="BlueArchive build script" \
    -DUSE_JEMALLOC=OFF \
    -DCRASH_REPORTER=OFF \
    -DCRASH_HANDLER=OFF
...
if $DO_INSTALL; then
    ...
    echo ""
    echo "Done! Restart your shell with: ba restart"
else
