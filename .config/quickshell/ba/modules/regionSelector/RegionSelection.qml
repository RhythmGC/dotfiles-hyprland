...
PanelWindow {
    ...
    property color overlayColor: Appearance.angelEverywhere ? "#55000000"
        : Appearance.baEverywhere ? "#88000000"
        : Appearance.auroraEverywhere ? "#66000000" : "#88111111"
    property color brightText: Appearance.baEverywhere ? Appearance.ba.colText
    ...
    property color brightSecondary: Appearance.baEverywhere ? Appearance.ba.colTextSecondary
    ...
    property color brightTertiary: Appearance.baEverywhere ? Appearance.ba.colPrimary
        : Appearance.auroraEverywhere ? Appearance.colors.colPrimary
        : (Appearance.m3colors.darkmode ? Appearance.colors.colTertiary : Qt.lighter(Appearance.colors.colPrimary))
    property color selectionBorderColor: Appearance.baEverywhere ? Appearance.ba.colBorder
        : Appearance.auroraEverywhere ? Appearance.aurora.colPopupBorder
        : ColorUtils.mix(brightText, brightSecondary, 0.5)
    property color selectionFillColor: Appearance.baEverywhere ? ColorUtils.transparentize(Appearance.ba.colPrimary, 0.8)
    ...
    property color onBorderColor: Appearance.baEverywhere ? Appearance.ba.colText
