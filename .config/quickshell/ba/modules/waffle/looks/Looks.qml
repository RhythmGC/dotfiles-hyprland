...
Singleton {
    ...
    // Glass mode: aurora/angel active (not BlueArchive which has its own aesthetic)
    readonly property bool glassActive: root.auroraEverywhere && !Appearance.baEverywhere
