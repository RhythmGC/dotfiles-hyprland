...
Item {
    ...
    property var searchIndex: [
        ...
        // === Background (3) ===
        { pageIndex: 3, pageName: "Background", section: "Wallpaper", label: "Use Material ba wallpaper", targetLabel: "Use Material ba wallpaper", keywords: ["wallpaper", "background", "material", "share", "image"] },
        ...
        { pageIndex: 5, pageName: "Gowall", section: "Color Scheme Source", label: "BlueArchive theme", targetLabel: "Color Scheme Source", keywords: ["gowall", "ba", "palette", "material you"] },
        ...
        // === About (10) ===
        { pageIndex: 10, pageName: "About", section: "", label: "About ba", targetLabel: "", keywords: ["about", "version", "credits", "github", "info"] },
