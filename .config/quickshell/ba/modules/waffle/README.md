...
- If you install baOS fully, you can press Super+Alt+W to switch to this style.
- If you're just copying the Quickshell config, run the shell as usual (`ba start`) then run `ba panelFamily cycle`
