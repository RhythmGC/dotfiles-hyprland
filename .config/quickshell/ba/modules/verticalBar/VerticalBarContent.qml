...
Item { // Bar content region
    ...
    Rectangle {
        ...
        color: {
            ...
            if (root.baEverywhere) return Appearance.ba.colLayer0
        ...
        radius: Appearance.angelEverywhere ? Appearance.angel.roundingNormal
            : root.baEverywhere ? Appearance.ba.roundingNormal
            : floatingStyle ? ((Config.options?.bar?.cornerStyle ?? 0) === 3 ? Appearance.rounding.normal : Appearance.rounding.windowRounding) : 0
        border.width: Appearance.angelEverywhere ? 0 : (root.baEverywhere ? 1 : (floatingStyle ? 1 : 0))
    ...
    Item {
        id: auroraBlurLayer
        anchors.fill: barBackground
        visible: root.auroraEverywhere && !root.baEverywhere && !root.gameModeMinimal
        ...
        Image {
            ...
            layer.enabled: Appearance.effectsEnabled && root.auroraEverywhere && !root.baEverywhere && !Appearance.compositorBlurActive
