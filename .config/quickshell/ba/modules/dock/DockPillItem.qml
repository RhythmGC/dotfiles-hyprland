...
Item {
    ...
    readonly property color _pillBg: {
        ...
        if (Appearance.baEverywhere) return ColorUtils.transparentize(Appearance.ba.colLayer2, 0.45)
    ...
    readonly property color _pillBorder: {
        ...
        if (Appearance.baEverywhere) return ColorUtils.transparentize(Appearance.ba.colBorderAccent, 0.55)
