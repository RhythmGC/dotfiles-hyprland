...
PopupWindow {
    ...
    MouseArea {
        ...
        GlassBackground {
            ...
            baColor: Appearance.ba?.colLayer2 ?? Appearance.colors.colSurfaceContainer
            auroraTransparency: Appearance.aurora?.popupTransparentize ?? 0.1
            radius: Appearance.angelEverywhere ? Appearance.angel.roundingNormal
                : Appearance.baEverywhere ? (Appearance.ba?.roundingNormal ?? 12) : Appearance.rounding.normal
            border.width: 1
            border.color: Appearance.angelEverywhere ? Appearance.angel.colBorder
                : Appearance.baEverywhere
                ? (Appearance.ba?.colBorder ?? "transparent")
