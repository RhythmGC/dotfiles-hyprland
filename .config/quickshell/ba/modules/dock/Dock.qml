                        ...
                        Item {
                            ...
                            StyledRectangularShadow {
                                ...
                                radius: Appearance.angelEverywhere ? Appearance.angel.roundingNormal
                                    : baEverywhere ? Appearance.ba.roundingNormal
                                    : cardStyle ? Appearance.rounding.normal : Appearance.rounding.large

                                clip: true
                                layer.enabled: auroraEverywhere && !baEverywhere && !gameModeMinimal
                                ...
                                Image {
                                    ...
                                    visible: dockVisualBackground.auroraEverywhere && !dockVisualBackground.baEverywhere && !dockVisualBackground.gameModeMinimal
                                    ...
                                    layer.enabled: Appearance.effectsEnabled && dockVisualBackground.auroraEverywhere && !dockVisualBackground.baEverywhere && !dockVisualBackground.gameModeMinimal && !Appearance.compositorBlurActive
