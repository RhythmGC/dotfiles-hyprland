...
Variants {
    ...
    PanelWindow {
        ...
        WlrLayershell.namespace: "quickshell:baBackdrop"
        ...
        // Material ba backdrop config (independent)
        readonly property var baBackdrop: Config.options?.background?.backdrop ?? {}

        readonly property int backdropBlurRadius: baBackdrop.blurRadius ?? 32
        readonly property int thumbnailBlurStrength: Config.options?.background?.effects?.thumbnailBlurStrength ?? 50
        readonly property bool enableAnimatedBlur: baBackdrop.enableAnimatedBlur ?? false
        readonly property int backdropDim: baBackdrop.dim ?? 35
        readonly property real backdropSaturation: baBackdrop.saturation ?? 0
        readonly property real backdropContrast: baBackdrop.contrast ?? 0
        readonly property bool vignetteEnabled: baBackdrop.vignetteEnabled ?? false
        readonly property real vignetteIntensity: baBackdrop.vignetteIntensity ?? 0.5
        readonly property real vignetteRadius: baBackdrop.vignetteRadius ?? 0.7
        readonly property bool useAuroraStyle: baBackdrop.useAuroraStyle ?? false
        readonly property real auroraOverlayOpacity: baBackdrop.auroraOverlayOpacity ?? 0.38
        readonly property bool enableAnimation: baBackdrop.enableAnimation ?? false
