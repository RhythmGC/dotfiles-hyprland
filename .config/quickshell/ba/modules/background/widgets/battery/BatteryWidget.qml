...
AbstractBackgroundWidget {
    ...
    readonly property color accentColor: Battery.isLow
        ? (Appearance.angelEverywhere ? Appearance.angel.colError
            : Appearance.baEverywhere ? Appearance.ba.colError
    ...
    Item {
        anchors.fill: parent
        anchors.margins: Appearance.angelEverywhere || Appearance.baEverywhere ? 4 : 0
    ...
    Item {
        anchors.fill: parent
        anchors.margins: Appearance.angelEverywhere || Appearance.baEverywhere ? 8 : 4
        opacity: 1.0 - root.dimFactor * 0.6
