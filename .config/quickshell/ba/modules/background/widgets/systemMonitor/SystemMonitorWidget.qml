...
AbstractBackgroundWidget {
    ...
    readonly property int _innerMargin: Appearance.angelEverywhere || Appearance.baEverywhere ? 6 : 2
    ...
    readonly property color memColor: Appearance.angelEverywhere ? Appearance.angel.colSecondary
        : Appearance.baEverywhere ? Appearance.ba.colSecondary
    ...
    readonly property color gpuColor: Appearance.angelEverywhere ? Appearance.angel.colTertiary
        : Appearance.baEverywhere ? Appearance.ba.colTertiary
        : Appearance.auroraEverywhere ? Appearance.m3colors.m3tertiary
        : Appearance.colors.colTertiary
    readonly property color tempColor: Appearance.baEverywhere ? Appearance.ba.colError
