...
Singleton {
    ...
    readonly property bool baEverywhere: globalStyle === "ba"
    ...
    // active global style instead of re-implementing the angel/ba/aurora/material ternary.
    readonly property color colLayer1Hover: angelEverywhere ? angel.colGlassCardHover
        : baEverywhere ? ba.colLayer1Hover
    ...
    readonly property color colLayer2Hover: angelEverywhere ? angel.colGlassElevatedHover
        : baEverywhere ? ba.colLayer2Hover
    ...
    // Font Strategy:
    // 1. Ba style -> Always Monospace (TUI feel)
    ...
    ba: QtObject {
        // Ba style - Elegant terminal UI aesthetic
