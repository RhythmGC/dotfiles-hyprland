...
Singleton {
    ...
    property bool isSettingsProcess: (Quickshell.env("BA_STANDALONE_WINDOW") ?? "") === "1"
    ...
    FileView {
        ...
        JsonAdapter {
            ...
            // Panel system
            property list<string> enabledPanels: ["baBar", "baBackground", "baBackdrop", "baIdleOverlay", "baCheatsheet", "baControlPanel", "baDock", "baLock", "baMediaControls", "baNotificationPopup", "baOnScreenDisplay", "baOnScreenKeyboard", "baOverlay", "baOverview", "baPolkit", "baRegionSelector", "baScreenCorners", "baSessionScreen", "baSidebarLeft", "baSidebarRight", "baTilingOverlay", "baVerticalBar", "baWallpaperSelector", "baCoverflowSelector", "baClipboard", "baShellUpdate"]
            property list<string> knownPanels: [] // Tracks panels the user has seen; used to distinguish "user disabled" from "new in update"
            property string panelFamily: "ba" // "ba" or "waffle"
            ...
            property JsonObject lock: JsonObject {
                ...
                property JsonObject notifications: JsonObject {
                    ...
                    property string position: "auto" // "auto" (center ba, right waffle), "center", "left", "right"
                }
            ...
            // Settings for the custom Alt-Tab switcher in ba
            ...
            property JsonObject waffles: JsonObject {
                ...
                property JsonObject theming: JsonObject {
                    property bool useMaterialColors: true // Use Material ba colors instead of W11 grey
