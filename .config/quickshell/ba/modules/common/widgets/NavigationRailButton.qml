    ...
    contentItem: Item {
        ...
        Rectangle {
            ...
            color: Appearance.angelEverywhere
                ...
                ? (toggled
                    ? (root.showToggledHighlight
                        ? (root.down ? Appearance.ba.colLayer2Active : root.hovered ? Appearance.ba.colLayer2Hover : Appearance.ba.colLayer2)
                        : "transparent")
                    : (root.down ? Appearance.ba.colLayer2Active : root.hovered ? Appearance.ba.colLayer2Hover : "transparent"))
