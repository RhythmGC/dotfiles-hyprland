...
Item {
    ...
    ColumnLayout {
        ...
        spacing: root.compact ? 6 : (Appearance.baEverywhere ? 8 : 10)

        Item {
            visible: root.icon !== ""
            Layout.alignment: Qt.AlignHCenter
            implicitWidth: Appearance.baEverywhere ? 72 : materialShape.implicitWidth
            implicitHeight: Appearance.baEverywhere ? 72 : materialShape.implicitHeight

            Rectangle {
                anchors.fill: parent
                visible: Appearance.baEverywhere
                radius: Appearance.ba.roundingNormal
                color: Appearance.ba.colLayer2
                border.width: 1
                border.color: Appearance.ba.colBorder
            }
            ...
            MaterialSymbol {
                ...
                text: root.icon
                iconSize: 32
                color: Appearance.ba.colTextSecondary
            }
