...
Rectangle {
    ...
    property color baColor: Appearance.ba.colLayer1
    ...
    color: angelEverywhere ? "transparent"
        ...
        : baEverywhere ? baColor
        : fallbackColor

    clip: true

    layer.enabled: (auroraEverywhere || angelEverywhere) && !baEverywhere
    ...
    Image {
        ...
        visible: (root.auroraEverywhere || root.angelEverywhere) && !root.baEverywhere && status === Image.Ready
        source: ((root.auroraEverywhere || root.angelEverywhere) && !root.baEverywhere) ? root.wallpaperUrl : ""
        ...
        layer.enabled: Appearance.effectsEnabled && (Appearance.auroraEverywhere || Appearance.angelEverywhere) && !Appearance.baEverywhere
    ...
    Rectangle {
        anchors.fill: parent
        visible: (root.auroraEverywhere || root.angelEverywhere) && !root.baEverywhere
