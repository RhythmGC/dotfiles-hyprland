        ...
        ColumnLayout {
            ...
            StyledText {
                ...
                color: Appearance.angelEverywhere ? Appearance.angel.colText
                     : Appearance.baEverywhere ? Appearance.ba.colLabel : Appearance.m3colors.m3onSurface
            ...
            Rectangle {
                color: Appearance.angelEverywhere ? Appearance.angel.colCardBorder
                     : Appearance.baEverywhere ? Appearance.ba.colBorderSubtle : Appearance.m3colors.m3outline
                implicitHeight: 1
