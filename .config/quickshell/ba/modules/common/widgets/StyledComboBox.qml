...
ComboBox {
    ...
    readonly property color _borderColor: Appearance.angelEverywhere ? Appearance.angel.colBorder
        ...
        : "transparent"
    readonly property real _borderWidth: (Appearance.angelEverywhere || Appearance.baEverywhere) ? 1 : 0
    readonly property color _popupColor: Appearance.baEverywhere ? Appearance.ba.colLayer2
    ...
    background: Rectangle {
        ...
        border.color: root.activeFocus
            ? (Appearance.angelEverywhere ? Appearance.angel.colPrimary
                : Appearance.baEverywhere ? Appearance.ba.colBorderFocus
                : root._borderColor)
            : root._borderColor
