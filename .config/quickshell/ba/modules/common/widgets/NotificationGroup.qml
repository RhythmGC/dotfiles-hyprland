...
MouseArea { // Notification group area
    ...
    Rectangle { // Background of the notification
        ...
        color: Appearance.angelEverywhere ? (popup ? "transparent" : Appearance.angel.colGlassCard)
            : Appearance.baEverywhere ? (popup ? Appearance.ba.colLayer2 : Appearance.ba.colLayer1)
        ...
        border.width: Appearance.angelEverywhere ? Appearance.angel.cardBorderWidth
            : (Appearance.baEverywhere || (Appearance.auroraEverywhere && popup)) ? 1 : 0
        ...
        layer.enabled: root.popup && Appearance.auroraEverywhere && !Appearance.baEverywhere
        ...
        Image {
            ...
            anchors.fill: parent
            visible: root.popup && Appearance.auroraEverywhere && !Appearance.baEverywhere
