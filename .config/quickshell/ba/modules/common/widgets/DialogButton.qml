...
RippleButton {
    ...
    buttonRadius: Appearance.angelEverywhere ? Appearance.angel.roundingSmall
               : Appearance.baEverywhere ? Appearance.ba.roundingSmall : (Appearance?.rounding.full ?? 9999)

    property color colEnabled: Appearance.angelEverywhere ? Appearance.angel.colPrimary
        : Appearance.baEverywhere ? Appearance.ba.colPrimary : (Appearance?.colors.colPrimary ?? "#65558F")
    property color colDisabled: Appearance.baEverywhere ? Appearance.ba.colTextDisabled : (Appearance?.m3colors.m3outline ?? "#8D8C96")
