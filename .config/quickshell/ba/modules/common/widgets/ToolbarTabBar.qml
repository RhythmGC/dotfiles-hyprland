    ...
    Flickable {
        ...
        Item {
            ...
            Item {
                ...
                height: Appearance.angelEverywhere ? 36 : Appearance.baEverywhere ? 36 : 40
                ...
                Rectangle {
                    ...
                    radius: Appearance.angelEverywhere ? Appearance.angel.roundingSmall
                        : Appearance.baEverywhere ? Appearance.ba.roundingSmall : height / 2
                ...
                Rectangle {
                    ...
                    color: Appearance.angelEverywhere ? Appearance.angel.colPrimary
                        : Appearance.baEverywhere ? ColorUtils.transparentize(Appearance.ba.colPrimary, 0.85)
                        : Appearance.auroraEverywhere ? Appearance.aurora.colSubSurface
                        : Appearance.colors.colSecondaryContainer
                    border.width: (Appearance.angelEverywhere || Appearance.baEverywhere) ? 1 : 0
                    border.color: Appearance.angelEverywhere ? Appearance.angel.colBorderHover
                        : Appearance.baEverywhere ? Appearance.ba.colBorderAccent : "transparent"
                    implicitWidth: targetItem ? targetItem.implicitWidth : 0
                    implicitHeight: targetItem ? (Appearance.angelEverywhere ? 28 : Appearance.baEverywhere ? 28 : (Appearance.auroraEverywhere ? 32 : targetItem.implicitHeight)) : 0
                    radius: Appearance.angelEverywhere ? Appearance.angel.roundingSmall
                        : Appearance.baEverywhere ? Appearance.ba.roundingSmall : height / 2
                    anchors.verticalCenter: parent.verticalCenter
                    // Animation
