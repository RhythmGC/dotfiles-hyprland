...
Rectangle {
    ...
    property real borderRadius: Appearance.baEverywhere ? Appearance.ba.roundingSmall : Appearance.rounding.verysmall
    ...
    color: Appearance.baEverywhere ? Appearance.ba.colBorderMuted : Appearance.colors.colSurfaceContainerHigh
    ...
    Rectangle {
        ...
        color: Appearance.baEverywhere ? Appearance.ba.colLayer2 : Appearance.colors.colSurfaceContainer
