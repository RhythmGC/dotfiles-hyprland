...
Item {
    ...
    ColumnLayout {
        ...
        spacing: Appearance.baEverywhere ? 8 : 5

        // Ba: simple rectangle with centered icon
        Item {
        ...
        StyledText {
            ...
            color: Appearance.baEverywhere ? Appearance.ba.colTextSecondary : Appearance.m3colors.m3outline
