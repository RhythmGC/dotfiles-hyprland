...
Scope {
    ...
    readonly property color accent: Appearance.baEverywhere
        ? Appearance.ba.colPrimary : Appearance.colors.colPrimary
    readonly property color accentAlt: Appearance.baEverywhere
        ? Appearance.ba.colText : Appearance.colors.colTertiary
    readonly property color textPrimary: Appearance.baEverywhere
        ? Appearance.ba.colText : Appearance.colors.colOnLayer0
    readonly property color textMuted: Appearance.baEverywhere
        ? Appearance.ba.colTextSecondary : Appearance.colors.colSubtext
    readonly property color glassColor: ColorUtils.transparentize(
        Appearance.baEverywhere ? Appearance.ba.colLayer0 : Appearance.colors.colLayer0,
        0.22
    )
    ...
    readonly property real panelRadius: Appearance.baEverywhere
        ? Appearance.ba.roundingLarge : Appearance.rounding.large
