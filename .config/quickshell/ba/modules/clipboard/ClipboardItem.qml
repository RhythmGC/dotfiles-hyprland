...
RippleButton {
    ...
    colBackground: (root.down || root.keyboardDown) 
        ? (Appearance.angelEverywhere ? Appearance.angel.colGlassCardActive
            : Appearance.baEverywhere ? Appearance.ba.colPrimaryActive : Appearance.colors.colPrimaryContainerActive)
    ...
    property string highlightPrefix: `<u><font color="${Appearance.baEverywhere ? Appearance.ba.colPrimary : Appearance.colors.colPrimary}">`
    ...
    RowLayout {
        ...
        ColumnLayout {
            ...
            StyledText {
                ...
                color: (root.isSelected || root.hovered || root.focus) ? (Appearance.baEverywhere ? Appearance.ba.colOnLayer3 : Appearance.colors.colOnLayer3) : (Appearance.baEverywhere ? Appearance.ba.colTextSecondary : Appearance.colors.colSubtext)
            ...
            RowLayout {
                Loader { // Checkmark for entries copied from this panel
                    ...
                    sourceComponent: Rectangle {
                        ...
                        radius: Appearance.baEverywhere ? Appearance.ba.roundingSmall : Appearance.rounding.full
                        color: Appearance.baEverywhere ? Appearance.ba.colPrimary : Appearance.colors.colPrimary
                        MaterialSymbol {
                            id: activeText
                            anchors.centerIn: parent
                            text: "check"
                            font.pixelSize: Appearance.font.pixelSize.normal
                            color: Appearance.baEverywhere ? Appearance.ba.colOnPrimary : Appearance.m3colors.m3onPrimary
                        }
                    }
                }
                ...
                StyledText { // Item name/content
                    ...
                    color: (root.isSelected || root.hovered || root.focus) ? (Appearance.baEverywhere ? Appearance.ba.colOnLayer3 : Appearance.colors.colOnLayer3) : (Appearance.baEverywhere ? Appearance.ba.colText : Appearance.m3colors.m3onSurface)
        ...
        StyledText {
            ...
            id: clickAction
            font.pixelSize: Appearance.font.pixelSize.normal
            color: Appearance.baEverywhere ? Appearance.ba.colOnSelection : Appearance.colors.colOnPrimaryContainer
        ...
        RowLayout {
            ...
            Repeater {
                ...
                delegate: RippleButton {
                    ...
                    implicitHeight: 32
                    implicitWidth: 32
                    buttonRadius: Appearance.baEverywhere ? Appearance.ba.roundingSmall : Appearance.rounding.small

                    colBackgroundHover: Appearance.baEverywhere ? Appearance.ba.colLayer3Hover : Appearance.colors.colLayer4Hover
                    colRipple: Appearance.baEverywhere ? Appearance.ba.colPrimaryActive : Appearance.colors.colLayer4Active
