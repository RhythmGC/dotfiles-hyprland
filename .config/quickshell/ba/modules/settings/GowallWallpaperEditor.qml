...
ColumnLayout {
    ...
    ContentSubsection {
        ...
        ConfigSelectionArray {
            ...
            options: [
                ...
                { displayName: Translation.tr("Current BlueArchive theme"), icon: "palette", value: "ba" },
    ...
    ContentSubsection {
        ...
        title: Translation.tr("Current BlueArchive palette")

        StyledText {
            Layout.fillWidth: true
            visible: !GowallService.hasCurrentThemePalette
            text: Translation.tr("The current BlueArchive Material You palette is not available yet. Regenerate your wallpaper colors and try again.")
            font.pixelSize: Appearance.font.pixelSize.smaller
            color: Appearance.colors.colSubtext
            wrapMode: Text.WordWrap
        }
