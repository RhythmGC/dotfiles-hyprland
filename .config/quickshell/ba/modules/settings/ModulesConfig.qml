...
ContentPage {
    ...
    readonly property var defaultPanels: ({
        "ba": [
            "baBar", "baBackground", "baBackdrop", "baCheatsheet", "baControlPanel", "baDock", "baLock",
            "baMediaControls", "baNotificationPopup", "baOnScreenDisplay", "baOnScreenKeyboard",
            "baOverlay", "baOverview", "baPolkit", "baRegionSelector", "baScreenCorners",
            "baSessionScreen", "baSidebarLeft", "baSidebarRight", "baTilingOverlay", "baVerticalBar",
            "baWallpaperSelector", "baCoverflowSelector", "baClipboard", "baShellUpdate"
        ],
        "waffle": [
            ...
            "baCheatsheet", "baOnScreenKeyboard", "baOverlay", "baOverview",
            "baRegionSelector", "baScreenCorners", "baWallpaperSelector", "baCoverflowSelector", "baClipboard"
        ]
    })
    ...
    function isBaBarEnabled(): bool {
        const panels = Config.options?.enabledPanels ?? []
        return panels.includes("baBar") || panels.includes("baVerticalBar")
    }

    function setBaBarEnabled(enabled: bool) {
        let panels = [...(Config.options?.enabledPanels ?? [])]

        const hasBar = panels.includes("baBar")
        const hasVerticalBar = panels.includes("baVerticalBar")

        if (enabled) {
            if (!hasBar) panels.push("baBar")
            if (!hasVerticalBar) panels.push("baVerticalBar")
        } else {
            panels = panels.filter(panel => panel !== "baBar" && panel !== "baVerticalBar")
        }
    ...
    function resetToDefaults() {
        const family = Config.options?.panelFamily ?? "ba"
        ...
        SettingsGroup {
            RowLayout {
                ...
                RippleButton {
                    ...
                    onClicked: {
                        Config.setNestedValue("panelFamily", "ba")
                        Config.setNestedValue("enabledPanels", [...modulesPage.defaultPanels["ba"]])
                    }
                }
    ...
    SettingsCardSection {
        ...
        SettingsGroup {
            SettingsSwitch {
                ...
                checked: modulesPage.isBaBarEnabled()
                onCheckedChanged: modulesPage.setBaBarEnabled(checked)
            ...
            SettingsSwitch {
                ...
                checked: modulesPage.isPanelEnabled("baBackground")
                onCheckedChanged: modulesPage.setPanelEnabled("baBackground", checked)
            ...
            SettingsSwitch {
                ...
                checked: modulesPage.isPanelEnabled("baBackdrop")
                onCheckedChanged: modulesPage.setPanelEnabled("baBackdrop", checked)
            ...
            SettingsSwitch {
                ...
                checked: modulesPage.isPanelEnabled("baOverview")
                onCheckedChanged: modulesPage.setPanelEnabled("baOverview", checked)
            ...
            SettingsSwitch {
                ...
                checked: modulesPage.isPanelEnabled("baOverlay")
                onCheckedChanged: modulesPage.setPanelEnabled("baOverlay", checked)
            ...
            SettingsSwitch {
                ...
                checked: modulesPage.isPanelEnabled("baSidebarLeft")
                onCheckedChanged: modulesPage.setPanelEnabled("baSidebarLeft", checked)
            ...
            SettingsSwitch {
                ...
                checked: modulesPage.isPanelEnabled("baSidebarRight")
                onCheckedChanged: modulesPage.setPanelEnabled("baSidebarRight", checked)
    ...
    SettingsCardSection {
        ...
        SettingsGroup {
            SettingsSwitch {
                ...
                checked: modulesPage.isPanelEnabled("baNotificationPopup")
                onCheckedChanged: modulesPage.setPanelEnabled("baNotificationPopup", checked)
            ...
            SettingsSwitch {
                ...
                checked: modulesPage.isPanelEnabled("baOnScreenDisplay")
                onCheckedChanged: modulesPage.setPanelEnabled("baOnScreenDisplay", checked)
            ...
            SettingsSwitch {
                ...
                checked: modulesPage.isPanelEnabled("baMediaControls")
                onCheckedChanged: modulesPage.setPanelEnabled("baMediaControls", checked)
    ...
    SettingsCardSection {
        ...
        SettingsGroup {
            SettingsSwitch {
                ...
                checked: modulesPage.isPanelEnabled("baLock")
                onCheckedChanged: modulesPage.setPanelEnabled("baLock", checked)
            ...
            SettingsSwitch {
                ...
                checked: modulesPage.isPanelEnabled("baSessionScreen")
                onCheckedChanged: modulesPage.setPanelEnabled("baSessionScreen", checked)
            ...
            SettingsSwitch {
                ...
                checked: modulesPage.isPanelEnabled("baPolkit")
                onCheckedChanged: modulesPage.setPanelEnabled("baPolkit", checked)
            ...
            SettingsSwitch {
                ...
                checked: modulesPage.isPanelEnabled("baRegionSelector")
                onCheckedChanged: modulesPage.setPanelEnabled("baRegionSelector", checked)
            ...
            SettingsSwitch {
                ...
                checked: modulesPage.isPanelEnabled("baWallpaperSelector")
                onCheckedChanged: modulesPage.setPanelEnabled("baWallpaperSelector", checked)
            ...
            SettingsSwitch {
                ...
                checked: modulesPage.isPanelEnabled("baCheatsheet")
                onCheckedChanged: modulesPage.setPanelEnabled("baCheatsheet", checked)
            ...
            SettingsSwitch {
                ...
                checked: modulesPage.isPanelEnabled("baOnScreenKeyboard")
                onCheckedChanged: modulesPage.setPanelEnabled("baOnScreenKeyboard", checked)
            ...
            SettingsSwitch {
                ...
                checked: modulesPage.isPanelEnabled("baClipboard")
                onCheckedChanged: modulesPage.setPanelEnabled("baClipboard", checked)
    ...
    SettingsCardSection {
        ...
        SettingsGroup {
            SettingsSwitch {
                ...
                checked: modulesPage.isPanelEnabled("baDock")
                onCheckedChanged: modulesPage.setPanelEnabled("baDock", checked)
            ...
            SettingsSwitch {
                ...
                checked: modulesPage.isPanelEnabled("baScreenCorners")
                onCheckedChanged: modulesPage.setPanelEnabled("baScreenCorners", checked)
