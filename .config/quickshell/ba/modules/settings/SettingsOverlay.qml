...
Scope {
    ...
    property var overlaySearchIndex: [
        ...
        // Themes (page 4)
        { pageIndex: 4, pageName: overlayPages[4].name, section: Translation.tr("Global Style"), label: Translation.tr("Global Style"), description: Translation.tr("Material, Cards, Aurora glass effect, Ba TUI style"), keywords: ["global", "style", "aurora", "ba", "material", "cards", "glass", "tui", "transparency", "blur"] },
        ...
        { pageIndex: 4, pageName: overlayPages[4].name, section: Translation.tr("Global Style"), label: Translation.tr("Ba"), description: Translation.tr("TUI-inspired style with accent borders"), keywords: ["ba", "tui", "terminal", "borders", "style", "minimal"] },
        ...
        // About (page 13)
        { pageIndex: 13, pageName: overlayPages[13].name, section: Translation.tr("About"), label: Translation.tr("About ba"), description: Translation.tr("Version info, credits and links"), keywords: ["about", "version", "credits", "github", "info"] }
    ]
    ...
    property string _lastFamily: Config.options?.panelFamily ?? "ba"

    Connections {
        target: Config.options ?? null
        function onPanelFamilyChanged() {
            root._lastFamily = Config.options?.panelFamily ?? "ba";
        ...
        sourceComponent: PanelWindow {
            ...
            Rectangle {
                ...
                radius: Appearance.angelEverywhere ? Appearance.angel.roundingLarge
                      : Appearance.baEverywhere ? Appearance.ba.roundingLarge
                ...
                border.color: Appearance.angelEverywhere ? Appearance.angel.colPanelBorder
                            : Appearance.baEverywhere
                                ? (Appearance.ba?.colBorder ?? Appearance.colors.colLayer0Border)
                                : "transparent"
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        Rectangle {
                            ...
                            border.color: overlaySearchField.activeFocus
                                ...
                                : (Appearance.angelEverywhere ? Appearance.angel.colCardBorder
                                  : Appearance.baEverywhere ? Appearance.ba.colBorderMuted
                        ...
                        RippleButton {
                            ...
                            implicitWidth: 36
                            implicitHeight: 36
                            onClicked: Quickshell.execDetached([Quickshell.shellPath("scripts/ba"), "lock", "activate"])
                            contentItem: MaterialSymbol {
                                anchors.centerIn: parent
                                horizontalAlignment: Text.AlignHCenter
                                text: "lock"
                    ...
                    RowLayout {
                        ...
                        Rectangle {
                                    ...
                                    Repeater {
                                        ...
                                        delegate: Column {
                                            ...
                                            readonly property color headerAccentColor: Appearance.angelEverywhere ? Appearance.angel.colPrimary
                                                : Appearance.baEverywhere ? Appearance.ba.colAccent
                                                : Appearance.colors.colPrimary
                            ...
                            RippleButton {
                                ...
                                onClicked: {
                                    ...
                                    Quickshell.execDetached([Quickshell.shellPath("scripts/ba"), "settings-window"])
                        ...
                        Rectangle {
                            ...
                            border.color: Appearance.angelEverywhere ? Appearance.angel.colCardBorder
                                        : Appearance.baEverywhere ? Appearance.ba.colBorderSubtle : "transparent"
                            clip: true
                            ...
                            delegate: Column {
                                ...
                                RippleButton {
                                    ...
                                    colBackgroundHover: Appearance.angelEverywhere ? Appearance.angel.colGlassCardHover
                                                      : Appearance.baEverywhere ? Appearance.ba.colLayer1Hover
                                                      : Appearance.auroraEverywhere ? Appearance.aurora.colSubSurface
                                                      : Appearance.colors.colLayer2
