...
ContentPage {
        ...
        SettingsGroup {
            ...
            ConfigRow {
                ...
                ConfigSwitch {
                    ...
                    StyledToolTip {
                        text: Translation.tr("Starship prompt palette - use 'palette = \"ba\"' in starship.toml")
                    }
                }
            }
    ...
    SettingsCardSection {
        ...
        SettingsGroup {
            ...
            ContentSubsection {
                ...
                ConfigSelectionArray {
                    ...
                    options: [
                        ...
                        { displayName: Translation.tr("Ba"), icon: "terminal", value: "ba" },
            ...
            StyledText {
                Layout.fillWidth: true
                text: Translation.tr("Material keeps the original surfaces. Cards enables rounded card containers everywhere. Aurora enables a wallpaper-tinted glass surface style across panels. Ba uses a TUI-inspired dark theme with accent-colored borders. Angel is the flagship glass style with refined blur, escalonado shadows, and partial accent borders.")
                color: Appearance.colors.colSubtext
                font.pixelSize: Appearance.font.pixelSize.smaller
                wrapMode: Text.WordWrap
            }
