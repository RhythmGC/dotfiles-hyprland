...
ContentPage {
    ...
    SettingsCardSection {
        ...
        SettingsGroup {
            SettingsSwitch {
                ...
                StyledToolTip { text: Translation.tr("Share wallpaper with Material ba style") }
            }
    ...
    SettingsCardSection {
        ...
        SettingsGroup {
            SettingsSwitch {
                ...
                StyledToolTip { text: Translation.tr("Apply the Material ba color scheme instead of Windows 11 grey") }
            }
    ...
    SettingsCardSection {
        ...
        SettingsGroup {
            StyledText {
                Layout.fillWidth: true
                text: Translation.tr("Settings for switching between Material ba and Waffle panel styles.")
                color: Appearance.colors.colSubtext
                font.pixelSize: Appearance.font.pixelSize.small
                wrapMode: Text.WordWrap
            }
