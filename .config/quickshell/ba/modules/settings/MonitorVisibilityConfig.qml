...
ContentPage {
    ...
    readonly property var baSurfaces: [
    ...
    SettingsCardSection {
        ...
        SettingsGroup {
            NoticeBox {
                Layout.fillWidth: true
                materialIcon: "info"
                text: Translation.tr("This page controls where BlueArchive shell surfaces appear. It does not change monitor resolution, scale, rotation, or physical output layout.")
            }
    ...
    SettingsCardSection {
        ...
        SettingsGroup {
            NoticeBox {
                Layout.fillWidth: true
                materialIcon: "apps"
                text: Translation.tr("These controls only affect the Material family: the ba bar, dock, and floating media controls.")
            }

            PresetActions {
                paths: root.surfacePaths(root.baSurfaces)
            }

            Repeater {
                model: root.baSurfaces
