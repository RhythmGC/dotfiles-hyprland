    ...
    SettingsCardSection {
                ...
                ColumnLayout {
                    ...
                    Rectangle {
                        ...
                        color: Appearance.baEverywhere
                            ? Qt.rgba(Appearance.ba.colAccent.r, Appearance.ba.colAccent.g, Appearance.ba.colAccent.b, 0.15)
                            : Qt.rgba(Appearance.colors.colTertiary.r, Appearance.colors.colTertiary.g, Appearance.colors.colTertiary.b, 0.15)
                        border.width: 1
                        border.color: Appearance.baEverywhere
                            ? Qt.rgba(Appearance.ba.colAccent.r, Appearance.ba.colAccent.g, Appearance.ba.colAccent.b, 0.3)
                        ...
                        RowLayout {
                            ...
                            MaterialSymbol {
                                ...
                                color: Appearance.baEverywhere ? Appearance.ba.colAccent : Appearance.colors.colTertiary
                            }
                            StyledText {
                                Layout.fillWidth: true
                                text: Translation.tr("Selecting backdrop wallpaper")
                                font.pixelSize: Appearance.font.pixelSize.small
                                color: Appearance.baEverywhere ? Appearance.ba.colOnLayer1 : Appearance.colors.colOnLayer1
                            }
                            MaterialSymbol {
                                text: "close"
                                font.pixelSize: Appearance.font.pixelSize.normal
        ...
        SettingsGroup {
            ...
            ColumnLayout {
                ...
                readonly property var baBackdrop: Config.options?.background?.backdrop ?? {}
                readonly property bool backdropEnabled: baBackdrop.enable ?? false
                readonly property string backdropPath: {
                    const useMain = baBackdrop.useMainWallpaper ?? true;
                    if (!useMain) {
                        ...
                        const globalBd = baBackdrop.wallpaperPath || ""
                        ...
                        Repeater {
                            ...
                            Item {
                                ...
                                Rectangle {
                                    ...
                                    border.width: Appearance.angelEverywhere ? Appearance.angel.cardBorderWidth
                                        : Appearance.baEverywhere ? 1 : (monitorStack.showingBackdrop ? 2 : 1)
                                    border.color: monitorStack.showingBackdrop
                                        ? (Appearance.angelEverywhere ? (Appearance.angel?.colPrimary ?? Appearance.colors.colPrimary) : Appearance.baEverywhere ? (Appearance.ba?.colAccent ?? Appearance.colors.colPrimary) : Appearance.colors.colPrimary)
                                        : (Appearance.angelEverywhere ? (Appearance.angel?.colCardBorder ?? Appearance.colors.colLayer0Border) : Appearance.baEverywhere ? (Appearance.ba?.colBorder ?? Appearance.colors.colLayer0Border) : Appearance.colors.colLayer0Border)
                                    clip: true
                                ...
                                Rectangle {
                                    ...
                                    Rectangle {
                                        ...
                                        height: width
                                        radius: width / 2
                                        color: Appearance.baEverywhere ? Appearance.ba.colAccent : Appearance.colors.colPrimary
                                        MaterialSymbol {
                                            anchors.centerIn: parent
                                            text: "check"
                                            font.pixelSize: Appearance.font.pixelSize.small
                                            color: Appearance.baEverywhere ? Appearance.ba.colOnPrimary : Appearance.colors.colOnPrimary
                                        }
                                    }
        ...
        SettingsGroup {
            RowLayout {
                ...
                RippleButtonWithIcon {
                    ...
                    onClicked: Qt.openUrlExternally(`${Directories.config}/baOS/config.json`)
                }
                ...
                RippleButtonWithIcon {
                    ...
                    onClicked: Quickshell.execDetached([Quickshell.shellPath("scripts/ba"), "cheatsheet", "toggle"])
                }
            }
