...
ContentPage {
    ...
    property bool isBaActive: Config.options?.panelFamily !== "waffle"
    readonly property var baParallax: Config.options?.background?.parallax ?? {}
    readonly property string baParallaxPreset: ParallaxMath.detectPreset(
        baParallax.zoom ?? baParallax.workspaceZoom ?? 1.0,
        baParallax.workspaceShift ?? 1,
        baParallax.panelShift ?? baParallax.sidebarShift ?? 0.15,
        baParallax.widgetDepth ?? baParallax.widgetsFactor ?? 1.2
    )

    function setBaParallaxAxis(value: string): void {
    ...
    function applyBaParallaxPreset(presetId: string): void {
    ...
    SettingsCardSection {
        ...
        SettingsGroup {
            SettingsSwitch {
                ...
                checked: root.baParallax.enable ?? ((root.baParallax.enableWorkspace ?? false) || (root.baParallax.enableSidebar ?? false))
            ...
            StyledText {
                Layout.fillWidth: true
                text: Translation.tr("When parallax is active, ba renders the wallpaper internally so workspace motion, widget depth and wallpaper transitions stay synchronized.")
                color: Appearance.colors.colSubtext
                font.pixelSize: Appearance.font.pixelSize.small
                wrapMode: Text.WordWrap
            }
            ...
            ContentSubsection {
                ...
                ConfigSelectionArray {
                    currentValue: root.baParallaxPreset === "custom" ? null : root.baParallaxPreset
                    options: [
                    ...
                    onSelected: newValue => root.applyBaParallaxPreset(newValue)
                }
            }
            ...
            ContentSubsection {
                ...
                ConfigSelectionArray {
                    currentValue: root.baParallax.axis
                        ?? ((root.baParallax.autoVertical ?? false) ? "auto" : ((root.baParallax.vertical ?? false) ? "vertical" : "horizontal"))
                    options: [
                    ...
                    onSelected: newValue => root.setBaParallaxAxis(newValue)
                }
            }
            ...
            ConfigRow {
                ...
                SettingsSwitch {
                    ...
                    checked: root.baParallax.enableWorkspace ?? false
                    enabled: root.baParallax.enable ?? true
                ...
                SettingsSwitch {
                    ...
                    checked: root.baParallax.enableSidebar ?? false
                    enabled: root.baParallax.enable ?? true
            ...
            ConfigSpinBox {
                ...
                value: Math.round((root.baParallax.zoom ?? root.baParallax.workspaceZoom ?? 1.0) * 100)
                from: 10
                to: 200
                stepSize: 1
                onValueChanged: {
            ...
            ConfigSpinBox {
                ...
                value: Math.round((root.baParallax.workspaceShift ?? 1) * 100)
                from: 0
                to: 150
                stepSize: 5
                enabled: (root.baParallax.enable ?? true) && (root.baParallax.enableWorkspace ?? false)
            ...
            ConfigSpinBox {
                ...
                value: Math.round((root.baParallax.panelShift ?? root.baParallax.sidebarShift ?? 0.15) * 100)
                from: 0
                to: 30
                stepSize: 1
                enabled: (root.baParallax.enable ?? true) && (root.baParallax.enableSidebar ?? false)
            ...
            ConfigSpinBox {
                ...
                value: Math.round((root.baParallax.widgetDepth ?? root.baParallax.widgetsFactor ?? 1.2) * 100)
                from: 50
                to: 180
                stepSize: 5
                enabled: root.baParallax.enable ?? true
            ...
            SettingsSwitch {
                ...
                checked: root.baParallax.pauseDuringTransitions ?? true
                enabled: root.baParallax.enable ?? true
            ...
            ConfigSpinBox {
                ...
                value: root.baParallax.transitionSettleMs ?? 220
                from: 0
                to: 1200
                stepSize: 20
                enabled: (root.baParallax.enable ?? true) && (root.baParallax.pauseDuringTransitions ?? true)
            ...
            ColumnLayout {
                ...
                Rectangle {
                    ...
                    color: Appearance.angelEverywhere ? Appearance.angel.colGlassCard
                         : Appearance.baEverywhere ? Appearance.ba.colLayer0
                         : Appearance.auroraEverywhere ? Appearance.aurora.colSubSurface
                         : Appearance.colors.colLayer0
                    border.width: Appearance.angelEverywhere ? Appearance.angel.cardBorderWidth
                        : Appearance.baEverywhere ? 1 : (Appearance.auroraEverywhere ? 0 : 1)
                    border.color: Appearance.angelEverywhere ? Appearance.angel.colCardBorder
                               : Appearance.baEverywhere ? Appearance.ba.colBorder
                            ...
                            Item {
                                ...
                                Rectangle {
                                    ...
                                    border.width: bgMonDelegate.isSelected && bgMultiMonPanel.showBackdropView
                                        ? (Appearance.angelEverywhere ? Appearance.angel.cardBorderWidth : Appearance.baEverywhere ? 1 : 2) : (Appearance.angelEverywhere ? Appearance.angel.cardBorderWidth : Appearance.baEverywhere ? 1 : 0)
                                    border.color: bgMonDelegate.isSelected && bgMultiMonPanel.showBackdropView
                                        ? (Appearance.angelEverywhere ? Appearance.angel.colPrimary : Appearance.baEverywhere ? Appearance.ba.colAccent : Appearance.colors.colPrimary)
                                        : (Appearance.angelEverywhere ? Appearance.angel.colCardBorder : Appearance.baEverywhere ? Appearance.ba.colBorder : "transparent")
                                    clip: true
                                    ...
                                    Rectangle {
                                        ...
                                        visible: bgMultiMonPanel.showBackdropView && bgMonDelegate.isSelected
                                        border.width: 2
                                        border.color: Appearance.baEverywhere ? Appearance.ba.colAccent : Appearance.colors.colPrimary
                                    }
                                }
                ...
                Rectangle {
                    ...
                    border.color: Appearance.angelEverywhere ? (Appearance.angel?.colCardBorder ?? Appearance.colors.colLayer0Border)
                               : Appearance.baEverywhere ? (Appearance.ba?.colBorder ?? Appearance.colors.colLayer0Border)
                               : Appearance.colors.colLayer0Border
                    clip: true
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        MaterialSymbol {
                            text: "open_with"
                            iconSize: 16
                            color: Appearance.baEverywhere ? Appearance.ba.colPrimary
                        ...
                        StyledText {
                            ...
                            font.pixelSize: Appearance.font.pixelSize.small
                            font.weight: Font.Medium
                            color: Appearance.baEverywhere ? Appearance.ba.colText
                        ...
                        RippleButton {
                            ...
                            implicitWidth: 26
                            implicitHeight: 26
                            buttonRadius: Appearance.baEverywhere ? Appearance.ba.roundingSmall : Appearance.rounding.full
                            colBackground: "transparent"
                            colBackgroundHover: Appearance.baEverywhere ? Appearance.ba.colLayer2Hover
                            ...
                            contentItem: MaterialSymbol {
                                ...
                                text: "restart_alt"
                                iconSize: 14
                                color: Appearance.baEverywhere ? Appearance.ba.colTextSecondary
