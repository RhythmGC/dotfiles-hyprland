...
ContentPage {
    ...
    SettingsCardSection {
        ...
        title: Translation.tr("BlueArchive Shell Updates")

        SettingsGroup {
            StyledText {
                Layout.fillWidth: true
                text: Translation.tr("Automatically checks the BlueArchive git repository for new versions and shows a notification in the bar.")
            ...
            ConfigSpinBox {
                ...
                StyledToolTip {
                    text: Translation.tr("How often to check for BlueArchive updates (in minutes). Default: 360 (6 hours)")
                }
            }
