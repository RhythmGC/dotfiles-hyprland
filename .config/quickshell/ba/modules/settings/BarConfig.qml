...
ContentPage {
    ...
    readonly property bool isBa: currentGlobalStyle === "ba"
    ...
    component ConflictNote: RowLayout {
        ...
        readonly property color noteColor: {
            if (warning) {
                return Appearance.baEverywhere ? Appearance.ba.colWarning
                     : Appearance.colors.colTertiary
            }
            return Appearance.baEverywhere ? Appearance.ba.colTextSecondary
    ...
    SettingsCardSection {
        ...
        SettingsGroup {
            StyledText {
                Layout.fillWidth: true
                text: Translation.tr("These settings only apply when using the Material (ba) panel style. Go to Modules → Panel Style to switch.")
            ...
            ContentSubsection {
                ...
                ConfigSelectionArray {
                    ...
                    options: [
                        ...
                        { displayName: Translation.tr("Roman"), icon: "account_balance", value: '["I","BA","III","IV","V","VI","VII","VIII","IX","X"]' }
                    ]
                }
            }
