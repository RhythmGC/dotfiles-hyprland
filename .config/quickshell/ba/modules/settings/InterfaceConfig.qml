...
ContentPage {
    ...
    SettingsCardSection {
        visible: root.isBaActive && !(Config.options?.settingsUi?.easyMode ?? false)
        expanded: false
        icon: "keyboard_tab"
        title: Translation.tr("Alt-Tab switcher (Material ba)")
                ...
                SettingsSwitch {
                    ...
                    StyledToolTip {
                        text: (Appearance.globalStyle === "material" || Appearance.globalStyle === "ba")
                            ...
                            : Translation.tr("Only available with Material or Ba global style")
                    }
                }
                    ...
                    Repeater {
                        ...
                        delegate: Rectangle {
                            ...
                            color: tzRowHover.containsMouse
                                ? (Appearance.baEverywhere ? Appearance.ba.colLayer2Hover : Appearance.colors.colLayer2Hover)
                                : (Appearance.baEverywhere ? Appearance.ba.colLayer2 : Appearance.colors.colLayer2)
