...
RowLayout {
    ...
    IconToolbarButton {
        ...
        onClicked: {
            ...
            Quickshell.execDetached([Quickshell.shellPath("scripts/ba"), "region", "googleLens"]);
        }
        text: "image_search"
        StyledToolTip {
    ...
    IconToolbarButton {
        ...
        colText: toggled ? (Appearance.baEverywhere ? Appearance.ba.colOnPrimary : Appearance.colors.colOnPrimary) : (Appearance.baEverywhere ? Appearance.ba.colText : Appearance.colors.colOnSurfaceVariant)
        background: MaterialShape {
            ...
            color: {
                if (songRecButton.toggled) {
                    return songRecButton.hovered ? (Appearance.baEverywhere ? Appearance.ba.colPrimaryHover : Appearance.colors.colPrimaryHover) : (Appearance.baEverywhere ? Appearance.ba.colPrimary : Appearance.colors.colPrimary)
                } else {
                    return songRecButton.hovered ? (Appearance.baEverywhere ? Appearance.ba.colLayer2Hover : Appearance.colors.colSurfaceContainerHigh) : (Appearance.baEverywhere ? Appearance.ba.colLayer2 : ColorUtils.transparentize(Appearance.colors.colSurfaceContainerHigh))
                }
            }
            Behavior on color {
