...
Item {
    ...
    readonly property bool baStyle: Appearance.baEverywhere
    readonly property bool auroraStyle: Appearance.auroraEverywhere
    property bool panelVisible: true
    readonly property bool useWallpaperBackdrop: root.panelVisible && (root.angelStyle || root.auroraStyle) && !root.baStyle && root.wallpaperUrl.length > 0
    ...
    // ── Style tokens ──
    readonly property color colText: angelStyle ? Appearance.angel.colText : baStyle ? Appearance.ba.colText : Appearance.colors.colOnLayer1
    readonly property color colSubtext: angelStyle ? Appearance.angel.colTextSecondary : baStyle ? Appearance.ba.colTextSecondary : Appearance.colors.colSubtext
    readonly property color colCardBg: angelStyle
        ...
        : baStyle ? Appearance.ba.colLayer0
    ...
    readonly property color colCard: angelStyle
        ...
        : baStyle ? Appearance.ba.colLayer1
        : auroraStyle ? ColorUtils.transparentize(
    ...
    readonly property color colBorder: angelStyle ? Appearance.angel.colBorder
        : baStyle ? Appearance.ba.colBorder
        : auroraStyle ? ColorUtils.transparentize(Appearance.colors.colOutlineVariant, 0.72)
        : Appearance.colors.colLayer0Border
    readonly property color colPrimary: angelStyle ? Appearance.angel.colPrimary : baStyle ? Appearance.ba.colPrimary : Appearance.colors.colPrimary
    readonly property color colOnPrimary: angelStyle ? Appearance.angel.colOnPrimary : baStyle ? Appearance.ba.colOnPrimary : Appearance.colors.colOnPrimary
    readonly property color colCardHover: angelStyle ? Appearance.angel.colGlassCardHover : baStyle ? Appearance.ba.colLayer2Hover
        : auroraStyle ? (Appearance.aurora?.colSubSurfaceHover ?? Appearance.colors.colLayer2Hover) : Appearance.colors.colLayer2Hover
    readonly property color colLayer2: angelStyle ? Appearance.angel.colGlassCard : baStyle ? Appearance.ba.colLayer2
    ...
    readonly property color panelGlassTint: angelStyle
        ...
        : baStyle ? root.colCard
        : auroraStyle ? ColorUtils.transparentize(root.colCard, 0.36)
        : ColorUtils.transparentize(root.colCard, 0.32)
    readonly property real cardRadius: angelStyle ? Appearance.angel.roundingSmall : baStyle ? Appearance.ba.roundingSmall : Appearance.rounding.normal
    readonly property real containerRadius: angelStyle ? Appearance.angel.roundingNormal : baStyle ? Appearance.ba.roundingNormal : Appearance.rounding.large
    readonly property int bw: (angelStyle || baStyle || auroraStyle) ? 1 : 1
    ...
    readonly property color mediaBg: {
        ...
        if (baStyle) return Appearance.ba.colLayer1
    ...
    readonly property color mediaText: hasPlayer ? (angelStyle ? Appearance.angel.colText : baStyle ? Appearance.ba.colText
        : (blendedColors?.colOnLayer0 ?? Appearance.colors.colOnLayer0)) : colText
    readonly property color mediaSub: hasPlayer ? (angelStyle ? Appearance.angel.colTextSecondary : baStyle ? Appearance.ba.colTextSecondary
        : (blendedColors?.colSubtext ?? Appearance.colors.colSubtext)) : colSubtext
    readonly property color mediaAccent: hasPlayer ? (angelStyle ? Appearance.angel.colPrimary : baStyle ? Appearance.ba.colPrimary
        : (blendedColors?.colPrimary ?? Appearance.colors.colPrimary)) : colPrimary
    readonly property color mediaTrack: angelStyle ? Appearance.angel.colGlassCard : baStyle ? Appearance.ba.colLayer2
        : (blendedColors?.colSecondaryContainer ?? Appearance.colors.colSecondaryContainer)
    readonly property color mediaHover: angelStyle ? Appearance.angel.colGlassCardHover : baStyle ? Appearance.ba.colLayer2Hover
    ...
    StyledRectangularShadow {
        ...
        visible: !root.baStyle && !root.auroraStyle
    ...
    GlassBackground {
        ...
        Flickable {
            ...
            Rectangle {
                ...
                color: root.baStyle ? root.colCard : "transparent"
                ...
                // Solid background for material/ba
                Rectangle {
                    anchors.fill: parent
                    radius: headerCard.radius
                ...
                RowLayout {
                    ...
                    RippleButton {
                        ...
                        onClicked: Quickshell.execDetached([Quickshell.shellPath("scripts/ba"), "settings"])
              ...
              Rectangle {
                  ...
                  layer.enabled: (root.angelStyle || root.auroraStyle) && !root.baStyle
                  layer.effect: GE.OpacityMask {
            ...
            Rectangle {
                ...
                Image {
                    ...
                    opacity: root.baStyle ? 0.15 : (root.auroraStyle ? 0.25 : 0.4)
                        ...
                        Rectangle {
                            ...
                            Rectangle {
                                ...
                                color: root.angelStyle ? Appearance.angel.colGlassCard
                                    : root.baStyle ? Appearance.ba.colLayer2
                    ...
                    RowLayout {
                        ...
                        RippleButton {
                            ...
                            buttonRadius: root.angelStyle ? Appearance.angel.roundingSmall
                                : root.baStyle ? Appearance.ba.roundingSmall : Appearance.rounding.full
    ...
    component QuickToggle: Rectangle {
        ...
        radius: root.angelStyle ? Appearance.angel.roundingSmall : root.baStyle ? Appearance.ba.roundingSmall : Appearance.rounding.normal
        ...
        border.color: root.angelStyle ? "transparent"
            : root.baStyle ? (active ? Appearance.ba.colPrimary : Appearance.ba.colBorderSubtle)
            : "transparent"
            ...
            MaterialSymbol {
                ...
                color: toggle.active ? root.colOnPrimary
                    : (root.angelStyle ? Appearance.angel.colText
                        : root.baStyle ? Appearance.ba.colText
            ...
            StyledText {
                ...
                color: toggle.active ? root.colOnPrimary
                    : (root.angelStyle ? Appearance.angel.colTextSecondary
                        : root.baStyle ? Appearance.ba.colTextSecondary
    ...
    component DashMiniSlider: RowLayout {
        ...
        RippleButton {
            ...
            colBackgroundHover: root.angelStyle ? Appearance.angel.colGlassCardHover
                : root.baStyle ? Appearance.ba.colLayer2Hover
    ...
    component WeatherChip: Rectangle {
        ...
        color: root.angelStyle ? ColorUtils.transparentize(root.colPrimary, 0.78)
            ...
            : Appearance.colors.colSecondaryContainer
        border.width: root.baStyle ? 1 : 0
        border.color: root.baStyle ? Appearance.ba.colBorderSubtle : "transparent"
