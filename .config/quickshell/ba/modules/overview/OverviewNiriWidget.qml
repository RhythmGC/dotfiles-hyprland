...
Item {
    ...
    property color activeBorderColor: Appearance.baEverywhere ? Appearance.ba.colPrimary : Appearance.colors.colSecondary
                    ...
                    Repeater {
                        ...
                        Rectangle {
                            ...
                            property color hoveredWorkspaceColor: ColorUtils.mix(defaultWorkspaceColor, 
                                ...
                                : Appearance.baEverywhere ? Appearance.ba.colLayer2Hover : Appearance.colors.colLayer1Hover, 0.1)
                            property color hoveredBorderColor: Appearance.angelEverywhere ? Appearance.angel.colBorderHover
                                : Appearance.baEverywhere ? Appearance.ba.colBorder : Appearance.colors.colLayer2Hover
                            ...
                            property real largeWorkspaceRadius: Appearance.angelEverywhere ? Appearance.angel.roundingNormal
                                : Appearance.baEverywhere ? Appearance.ba.roundingNormal : Appearance.rounding.large
                            property real smallWorkspaceRadius: Appearance.angelEverywhere ? Appearance.angel.roundingSmall
                                : Appearance.baEverywhere ? Appearance.ba.roundingSmall : Appearance.rounding.verysmall
                            ...
                            Rectangle {
                                ...
                                border.color: hoveredWhileDragging
                                    ...
                                    : (Appearance.angelEverywhere ? ColorUtils.transparentize(Appearance.angel.colBorder, 0.64)
                                        : Appearance.baEverywhere ? ColorUtils.transparentize(Appearance.ba.colBorder, 0.45)
