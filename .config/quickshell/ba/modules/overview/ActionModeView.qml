        ...
        ListView {
            ...
            delegate: RippleButton {
                ...
                readonly property color normalTextColor: Appearance.angelEverywhere ? Appearance.angel.colText
                    : Appearance.baEverywhere ? Appearance.ba.colText : Appearance.colors.colOnLayer1
                ...
                buttonRadius: Appearance.angelEverywhere ? Appearance.angel.roundingSmall
                    : Appearance.baEverywhere ? Appearance.ba.roundingSmall : Appearance.rounding.normal
                ...
                RowLayout {
                    ...
                    Rectangle {
                        ...
                        radius: Appearance.angelEverywhere ? Appearance.angel.roundingSmall
                            : Appearance.baEverywhere ? Appearance.ba.roundingSmall
                            : Appearance.rounding.full
                        color: {
                            if (isPackage && entry.pkg?.installed)
                                return ColorUtils.transparentize(
                                    Appearance.baEverywhere ? Appearance.ba.colPrimary : Appearance.colors.colPrimary, 0.3)
                        ...
                        MaterialSymbol {
                            ...
                            color: {
                                if (isPackage && entry.pkg?.installed)
                                    return Appearance.baEverywhere ? Appearance.ba.colPrimary : Appearance.colors.colPrimary
                                return delegateBtn.isHighlighted
                    ...
                    RowLayout {
                        ...
                        Rectangle {
                            ...
                            color: entry?.pkg?.isAur
                                ? ColorUtils.transparentize(Appearance.baEverywhere ? Appearance.ba.colPrimary : Appearance.colors.colPrimary, 0.3)
                                : (Appearance.baEverywhere ? Appearance.ba.colLayer2 : Appearance.colors.colSecondaryContainer)
                            ...
                            StyledText {
                                ...
                                color: entry?.pkg?.isAur
                                    ...
                                    : (Appearance.baEverywhere ? Appearance.ba.colText : Appearance.colors.colOnSecondaryContainer)
                            }
                        }
                        ...
                        Rectangle {
                            ...
                            color: ColorUtils.transparentize(
                                Appearance.baEverywhere ? Appearance.ba.colPrimary : Appearance.colors.colPrimary, 0.2)
