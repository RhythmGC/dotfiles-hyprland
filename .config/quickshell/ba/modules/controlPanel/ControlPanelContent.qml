...
Item {
    ...
    readonly property bool useWallpaperBackdrop: root.auroraEverywhere && !root.baEverywhere && !Appearance.gameModeMinimal && root.wallpaperUrl.length > 0
    ...
    StyledRectangularShadow {
        target: background
        visible: (Appearance.angelEverywhere || (!root.baEverywhere && !root.auroraEverywhere)) && !Appearance.gameModeMinimal
    }
    ...
    Rectangle {
        ...
        color: root.baEverywhere ? Appearance.ba.colLayer0
        ...
        radius: root.angelEverywhere ? Appearance.angel.roundingLarge
            : root.baEverywhere ? Appearance.ba.roundingLarge
            : Appearance.rounding.large
        
        border.width: root.baEverywhere ? 1 : (root.auroraEverywhere ? 1 : 1)
        border.color: root.angelEverywhere ? Appearance.angel.colBorder
                    : root.baEverywhere ? Appearance.ba.colBorder
        ...
        Image {
            ...
            layer.enabled: Appearance.effectsEnabled && root.auroraEverywhere && !root.baEverywhere
