    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            MaterialSymbol {
                text: "wallpaper"
                iconSize: 16
                color: root.baEverywhere ? Appearance.ba.colPrimary
            ...
            StyledText {
                ...
                color: root.baEverywhere ? Appearance.ba.colText
            ...
            RippleButton {
                implicitWidth: 26
                implicitHeight: 26
                buttonRadius: root.baEverywhere ? Appearance.ba.roundingSmall : Appearance.rounding.full
                colBackground: "transparent"
                colBackgroundHover: root.baEverywhere ? Appearance.ba.colLayer2Hover
                ...
                contentItem: MaterialSymbol {
                    ...
                    text: "shuffle"
                    iconSize: 14
                    color: root.baEverywhere ? Appearance.ba.colTextSecondary
        ...
        Item {
            ...
            Rectangle {
                id: previewMask
                anchors.fill: parent
                radius: root.baEverywhere ? Appearance.ba.roundingSmall : Appearance.rounding.small
                visible: false
            }
