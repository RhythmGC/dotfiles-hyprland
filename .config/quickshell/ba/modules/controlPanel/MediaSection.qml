...
Item {
    ...
    Rectangle {
        ...
        radius: Appearance.angelEverywhere ? Appearance.angel.roundingNormal
             : root.baEverywhere ? Appearance.ba.roundingNormal : Appearance.rounding.normal
        color: Appearance.angelEverywhere ? "transparent"
             : root.baEverywhere ? Appearance.ba.colLayer1
        ...
        border.color: Appearance.angelEverywhere ? "transparent"
                    : root.baEverywhere ? Appearance.ba.colBorder : "transparent"
        clip: true
        ...
        Image {
            ...
            smooth: true
            mipmap: true
            opacity: root.displayedArtFilePath !== "" ? (root.baEverywhere ? 0.15 : (root.auroraEverywhere ? 0.25 : 0.5)) : 0
            visible: opacity > 0
            Behavior on opacity {
                enabled: Appearance.animationsEnabled
            ...
            layer.effect: MultiEffect {
                blurEnabled: true
                blur: root.baEverywhere ? 0.3 : 0.15
                blurMax: 16
                saturation: root.baEverywhere ? 0.1 : 0.3
            }
        }
        ...
        Rectangle {
            anchors.fill: parent
            visible: !root.baEverywhere && !root.auroraEverywhere
            gradient: Gradient {
        ...
        WaveVisualizer {
            ...
            color: ColorUtils.transparentize(
                ...
                : root.baEverywhere ? root.jiraColPrimary : (root.blendedColors?.colPrimary ?? Appearance.colors.colPrimary),
                0.6
            )
        }
            ...
            Rectangle {
                ...
                Rectangle {
                    ...
                    color: Appearance.angelEverywhere ? Appearance.angel.colGlassCard
                        : root.baEverywhere ? root.jiraColLayer2 : (root.blendedColors?.colLayer1 ?? Appearance.colors.colLayer1)
                    ...
                    MaterialSymbol {
                        ...
                        color: Appearance.angelEverywhere ? Appearance.angel.colTextSecondary
                            : root.baEverywhere ? root.jiraColTextSecondary : (root.blendedColors?.colSubtext ?? Appearance.colors.colSubtext)
                    }
                }
            }
            ...
            ColumnLayout {
                ...
                StyledText {
                    ...
                    color: Appearance.angelEverywhere ? Appearance.angel.colText
                        : root.baEverywhere ? root.jiraColText : (root.blendedColors?.colOnLayer0 ?? Appearance.colors.colOnLayer0)
                    ...
                    Loader {
                        ...
                        sourceComponent: StyledSlider {
                            ...
                            trackColor: Appearance.angelEverywhere ? Appearance.angel.colGlassCard
                                : root.baEverywhere ? Appearance.ba.colLayer2 : (root.blendedColors?.colSecondaryContainer ?? Appearance.colors.colSecondaryContainer)
                ...
                RowLayout {
                    ...
                    RippleButton {
                        ...
                        buttonRadius: Appearance.angelEverywhere ? Appearance.angel.roundingSmall
                            : root.baEverywhere ? Appearance.ba.roundingSmall : Appearance.rounding.full
                        colBackground: "transparent"
                        colBackgroundHover: Appearance.angelEverywhere ? Appearance.angel.colGlassCardHover
                            : root.baEverywhere ? Appearance.ba.colLayer2Hover : ColorUtils.transparentize(root.blendedColors?.colLayer1 ?? Appearance.colors.colLayer1, 0.5)
                        colRipple: Appearance.angelEverywhere ? Appearance.angel.colGlassCardActive
                            : root.baEverywhere ? Appearance.ba.colLayer2Active : (root.blendedColors?.colLayer1Active ?? Appearance.colors.colLayer1Active)
