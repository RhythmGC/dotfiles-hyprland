...
Item { // Player instance - Old style design
    ...
    component TrackChangeButton: RippleButton {
        ...
        colBackground: Appearance.angelEverywhere ? "transparent"
            : Appearance.baEverywhere ? "transparent"
    ...
    Rectangle { // Background
        ...
        border.width: Appearance.angelEverywhere ? 0 : ((Appearance.baEverywhere || Appearance.auroraEverywhere) ? 1 : 0)
        ...
        Image {
            ...
            antialiasing: true
            asynchronous: true
            opacity: Appearance.baEverywhere ? 0.5 : 0.3
            ...
            ColumnLayout { // Info & controls
                ...
                Item {
                        ...
                        Item {
                            ...
                            Loader {
                                ...
                                sourceComponent: StyledSlider {
                                    ...
                                    highlightColor: Appearance.baEverywhere ? Appearance.ba.colPrimary
                                        : Appearance.auroraEverywhere ? Appearance.colors.colPrimary
                                        : blendedColors.colPrimary
                                    trackColor: Appearance.baEverywhere ? Appearance.ba.colLayer2
                                        : Appearance.auroraEverywhere ? Appearance.aurora.colElevatedSurface
                                        : blendedColors.colSecondaryContainer
                                    handleColor: Appearance.baEverywhere ? Appearance.ba.colPrimary
                                        : Appearance.auroraEverywhere ? Appearance.colors.colPrimary
                                        : blendedColors.colPrimary
                    ...
                    RippleButton {
                        ...
                        buttonRadius: Appearance.baEverywhere ? Appearance.ba.roundingSmall
                            : Appearance.auroraEverywhere ? Appearance.rounding.normal
                            : (root.player?.isPlaying ? Appearance?.rounding.normal : size / 2)
                        colBackground: Appearance.baEverywhere ? "transparent"
                            : Appearance.auroraEverywhere ? "transparent"
