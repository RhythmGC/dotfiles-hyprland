...
Item {
    ...
    // Ba fixed colors
    readonly property color baText: Appearance.ba.colText
    readonly property color baTextSecondary: Appearance.ba.colTextSecondary
    readonly property color baPrimary: Appearance.ba.colPrimary
    readonly property color baLayer1: Appearance.ba.colLayer1
    readonly property color baLayer2: Appearance.ba.colLayer2
    ...
    Rectangle {
        ...
        radius: Appearance.angelEverywhere ? Appearance.angel.roundingNormal
             : Appearance.baEverywhere ? Appearance.ba.roundingNormal : root.radius
        color: Appearance.angelEverywhere ? "transparent"
             : Appearance.baEverywhere ? root.baLayer1
             : Appearance.auroraEverywhere ? "transparent"
             : (blendedColors?.colLayer0 ?? Appearance.colors.colLayer0)
        border.width: (Appearance.angelEverywhere || Appearance.baEverywhere || Appearance.auroraEverywhere) ? 1 : 0
        ...
        Image {
            ...
            visible: Appearance.auroraEverywhere && !Appearance.baEverywhere
            ...
            layer.enabled: Appearance.effectsEnabled && Appearance.auroraEverywhere && !Appearance.baEverywhere
        ...
        Image {
            ...
            smooth: true
            mipmap: true
            opacity: Appearance.baEverywhere ? 0.15 : (Appearance.auroraEverywhere ? 0.2 : 0.5)
            visible: root.displayedArtFilePath !== ""

            layer.enabled: Appearance.effectsEnabled
            layer.effect: MultiEffect {
                blurEnabled: true
                blur: Appearance.baEverywhere ? 0.3 : 0.15
                blurMax: 16
                saturation: Appearance.baEverywhere ? 0.1 : 0.3
            }
        }
        ...
        Rectangle {
            anchors.fill: parent
            visible: !Appearance.baEverywhere && !Appearance.auroraEverywhere
            gradient: Gradient {
        ...
        WaveVisualizer {
            ...
            color: ColorUtils.transparentize(
                Appearance.baEverywhere ? root.baPrimary : (blendedColors?.colPrimary ?? Appearance.colors.colPrimary),
                0.6
            )
        }
        ...
        RowLayout {
            ...
            Rectangle {
                ...
                Rectangle {
                    anchors.fill: parent
                    color: Appearance.baEverywhere ? root.baLayer2 : (blendedColors?.colLayer1 ?? Appearance.colors.colLayer1)
                    ...
                    MaterialSymbol {
                        ...
                        text: "music_note"
                        iconSize: 32
                        color: Appearance.baEverywhere ? root.baTextSecondary : (blendedColors?.colSubtext ?? Appearance.colors.colSubtext)
                    }
                }
            }
            ...
            ColumnLayout {
                ...
                StyledText {
                    ...
                    color: Appearance.baEverywhere ? root.baText : (blendedColors?.colOnLayer0 ?? Appearance.colors.colOnLayer0)
                ...
                Item {
                    ...
                    Loader {
                        ...
                        sourceComponent: StyledSlider {
                            ...
                            highlightColor: Appearance.baEverywhere ? root.baPrimary
                                : Appearance.auroraEverywhere ? Appearance.colors.colPrimary
                                : (blendedColors?.colPrimary ?? Appearance.colors.colPrimary)
                            trackColor: Appearance.baEverywhere ? root.baLayer2
                                : Appearance.auroraEverywhere ? Appearance.aurora.colElevatedSurface
                                : (blendedColors?.colSecondaryContainer ?? Appearance.colors.colSecondaryContainer)
                            handleColor: Appearance.baEverywhere ? root.baPrimary
                                : Appearance.auroraEverywhere ? Appearance.colors.colPrimary
                                : (blendedColors?.colPrimary ?? Appearance.colors.colPrimary)
                ...
                RowLayout {
                    ...
                    RippleButton {
                        ...
                        colRipple: Appearance.baEverywhere ? Appearance.ba.colLayer2Active
                        ...
                        contentItem: Item {
                            MaterialSymbol {
                                ...
                                color: Appearance.baEverywhere ? root.baText
                    ...
                    RippleButton {
                        ...
                        contentItem: Item {
                            MaterialSymbol {
                                ...
                                iconSize: 24; fill: 1
                                color: Appearance.baEverywhere ? root.baPrimary
                                    : Appearance.auroraEverywhere ? Appearance.colors.colOnLayer0
