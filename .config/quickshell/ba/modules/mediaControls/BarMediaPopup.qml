                ...
                Rectangle {
                    ...
                    color: isActive 
                        ? (Appearance.angelEverywhere ? Appearance.angel.colPrimary
                            : (Appearance.baEverywhere && Appearance.ba) ? Appearance.ba.colPrimary : Appearance.colors.colPrimary)
                        : (Appearance.angelEverywhere ? Appearance.angel.colGlassCard
                            : (Appearance.baEverywhere && Appearance.ba) ? Appearance.ba.colLayer2 : Appearance.colors.colLayer2)
        ...
        Item {
            ...
            Rectangle {
                ...
                color: Appearance.angelEverywhere ? Appearance.angel.colGlassCard
                    : (Appearance.baEverywhere && Appearance.ba) ? Appearance.ba.colLayer1
                    : (Appearance.auroraEverywhere && Appearance.aurora) ? Appearance.aurora.colPopupSurface
                     : Appearance.colors.colLayer0
                radius: Appearance.angelEverywhere ? Appearance.angel.roundingNormal
                    : (Appearance.baEverywhere && Appearance.ba) ? Appearance.ba.roundingNormal : root.popupRounding
                border.width: Appearance.angelEverywhere ? 0 : ((Appearance.baEverywhere || Appearance.auroraEverywhere) ? 1 : 0)
                border.color: Appearance.angelEverywhere ? "transparent"
                            : (Appearance.baEverywhere && Appearance.ba) ? Appearance.ba.colBorder
                ...
                ColumnLayout {
                    ...
                    StyledText {
                        ...
                        color: Appearance.angelEverywhere ? Appearance.angel.colText
                            : (Appearance.baEverywhere && Appearance.ba) ? Appearance.ba.colText
                            : (Appearance.auroraEverywhere && Appearance.aurora) ? Appearance.colors.colOnLayer0
                            : Appearance.colors.colOnLayer0
                    }
                    StyledText {
                        color: Appearance.angelEverywhere ? Appearance.angel.colTextSecondary
                            : (Appearance.baEverywhere && Appearance.ba) ? Appearance.ba.colTextSecondary
