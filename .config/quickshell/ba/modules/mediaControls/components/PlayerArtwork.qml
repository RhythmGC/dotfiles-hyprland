...
Rectangle {
    ...
    // Optional properties
    property real artRadius: Appearance.baEverywhere ? Appearance.ba.roundingSmall : Appearance.rounding.small
    property color placeholderColor: Appearance.baEverywhere
        ? Appearance.ba.colLayer2
        : Appearance.colors.colLayer1
    property color iconColor: Appearance.baEverywhere
        ? Appearance.ba.colTextSecondary
