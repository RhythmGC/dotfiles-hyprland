...
Scope {
    ...
    property real popupRounding: Appearance.baEverywhere ? Appearance.ba.roundingLarge : Appearance.rounding.large
                ...
                ColumnLayout {
                    ...
                    Item { // No player placeholder
                        ...
                        Rectangle {
                            ...
                            radius: Appearance.baEverywhere ? Appearance.ba.roundingLarge : root.popupRounding
                            border.width: Appearance.baEverywhere || Appearance.auroraEverywhere ? 1 : 0
