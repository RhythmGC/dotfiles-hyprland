...
Item { // Bar content region
    ...
    component VerticalBarSeparator: Rectangle {
        ...
        implicitWidth: 1
        color: root.baEverywhere ? Appearance.ba.colBorderSubtle : root.separatorColor
    }
    ...
    Rectangle {
        ...
        radius: {
            ...
            if (root.baEverywhere) {
                // Ba: use ba rounding for Float/Card, 0 for Hug/Rect
                if (cornerStyle === 1 || cornerStyle === 3) {
                    return Appearance.ba.roundingNormal
                }
                return 0
            }
            if (floatingStyle) {
        ...
        border.color: {
            ...
            if (root.baEverywhere) {
                return Appearance.ba.colBorder
            }
            if (auroraEverywhere) {
        ...
        layer.enabled: auroraEverywhere && !root.baEverywhere && !gameModeMinimal
        ...
        Image {
            ...
            visible: barBackground.auroraEverywhere && !root.baEverywhere && !barBackground.gameModeMinimal && !Appearance.compositorBlurActive
            ...
            layer.enabled: Appearance.effectsEnabled && barBackground.auroraEverywhere && !root.baEverywhere && !Appearance.compositorBlurActive
