...
/**
 * Compact timer indicator for the ba bar.
...
MouseArea {
    ...
    Rectangle {
        ...
        color: {
            ...
            if (root.paused) {
                ...
                if (Appearance.baEverywhere) return root.containsMouse ? Appearance.ba.colLayer2Active : Appearance.ba.colLayer2Hover
    ...
    RowLayout {
        ...
        MaterialSymbol {
            ...
            color: root.paused
                ? (Appearance.baEverywhere ? Appearance.ba.colTextMuted : Appearance.colors.colOnLayer1Inactive)
                : root.accentColor
        ...
        Item {
            ...
            MaterialSymbol {
                ...
                color: Appearance.baEverywhere ? Appearance.ba.colTextMuted : Appearance.colors.colOnLayer1Inactive
            }
        }
    }
