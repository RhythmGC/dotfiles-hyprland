...
MaterialSymbol {
    ...
    Rectangle {
        ...
        radius: Appearance.baEverywhere ? Appearance.ba.roundingSmall : Math.min(width, height) / 2
        color: Appearance.baEverywhere ? Appearance.ba.colPrimary : Appearance.colors.colOnLayer0
        z: 1
        ...
        StyledText {
            ...
            color: Appearance.baEverywhere ? Appearance.ba.colOnPrimary : Appearance.colors.colLayer0
