...
/**
 * Compact BlueArchive shell update indicator for the bar.
...
MouseArea {
    ...
    readonly property color accentColor: Appearance.angelEverywhere ? Appearance.angel.colPrimary
        : Appearance.baEverywhere ? (Appearance.ba?.colAccent ?? Appearance.m3colors.m3primary)
    ...
    Rectangle {
        ...
        color: {
            if (ShellUpdates.isUpdating) {
                ...
                if (Appearance.baEverywhere) return ColorUtils.transparentize(Appearance.ba?.colAccent ?? Appearance.m3colors.m3primary, 0.92)
            ...
            if (root.pressed) {
                ...
                if (Appearance.baEverywhere) return Appearance.ba.colLayer2Active
            ...
            if (root.containsMouse) {
                ...
                if (Appearance.baEverywhere) return Appearance.ba.colLayer1Hover
            ...
            if (Appearance.baEverywhere) return ColorUtils.transparentize(Appearance.ba?.colAccent ?? Appearance.m3colors.m3primary, 0.85)
        ...
        border.width: (Appearance.angelEverywhere || Appearance.baEverywhere) ? 1 : 0
        ...
        Item {
            ...
            ColumnLayout {
                ...
                Row {
                    ...
                    StyledText {
                        anchors.verticalCenter: parent.verticalCenter
                        text: ShellUpdates.isUpdating ? Translation.tr("Updating...") : Translation.tr("BlueArchive Update")
                        font {
                            weight: Font.Medium
