...
Button {
    ...
    background: Rectangle {
        radius: Appearance.baEverywhere ? (Appearance.ba?.roundingSmall ?? 8) : Appearance.rounding.small
        color: root.down
            ? ColorUtils.transparentize(Appearance.baEverywhere ? Appearance.ba?.colPrimary ?? Appearance.colors.colPrimary : Appearance.colors.colPrimary, 0.7)
            : (root.hovered
                ? ColorUtils.transparentize(Appearance.baEverywhere ? Appearance.ba?.colLayer2Hover ?? Appearance.colors.colSurfaceContainerHigh : Appearance.colors.colSurfaceContainerHigh, 0.5)
                : "transparent")
    ...
    contentItem: ColumnLayout {
            ...
            RippleButton {
                ...
                contentItem: MaterialSymbol {
                    ...
                    color: root.hovered
                        ...
                        : (Appearance.baEverywhere ? Appearance.ba?.colTextSecondary ?? Appearance.colors.colSubtext : Appearance.colors.colSubtext)
                }
            }
        }
        ...
        Item {
            ...
            Rectangle {
                ...
                color: Appearance.baEverywhere
                    ? (Appearance.ba?.colLayer1 ?? Appearance.colors.colSurfaceContainerLow)
