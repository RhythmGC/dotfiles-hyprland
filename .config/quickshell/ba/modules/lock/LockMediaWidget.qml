...
Item {
    ...
    // Ba uses fixed colors instead of adaptive
    readonly property color jiraColText: Appearance.ba.colText
    readonly property color jiraColTextSecondary: Appearance.ba.colTextSecondary
    readonly property color jiraColPrimary: Appearance.ba.colPrimary
    readonly property color jiraColLayer1: Appearance.ba.colLayer1
    readonly property color jiraColLayer2: Appearance.ba.colLayer2

    StyledRectangularShadow { target: card; visible: Appearance.angelEverywhere || (!Appearance.baEverywhere && !Appearance.auroraEverywhere) }
    ...
    Rectangle {
        ...
        Image {
            ...
            asynchronous: true
            cache: false
            opacity: Appearance.baEverywhere ? 0.2 : (Appearance.auroraEverywhere ? 0.3 : 0.6)
            visible: root.displayedArtFilePath !== ""

            layer.enabled: Appearance.effectsEnabled
            layer.effect: MultiEffect {
                blurEnabled: true
                blur: Appearance.baEverywhere ? 0.5 : 0.4
                blurMax: 32
                saturation: Appearance.baEverywhere ? 0.1 : 0.4
            }
        }
        ...
        WaveVisualizer {
            ...
            color: ColorUtils.transparentize(
                Appearance.baEverywhere ? root.jiraColPrimary : (blendedColors?.colPrimary ?? Appearance.colors.colPrimary),
                0.6
            )
        }
        ...
        RowLayout {
            ...
            Rectangle {
                ...
                radius: Appearance.baEverywhere ? Appearance.ba.roundingSmall : Appearance.rounding.small
                color: "transparent"
                clip: true
                ...
                Rectangle {
                    anchors.fill: parent
                    color: Appearance.baEverywhere ? root.jiraColLayer2 : (blendedColors?.colLayer1 ?? Appearance.colors.colLayer1)
                    ...
                    MaterialSymbol {
                        ...
                        text: "music_note"
                        iconSize: 32
                        color: Appearance.baEverywhere ? root.jiraColTextSecondary : (blendedColors?.colSubtext ?? Appearance.colors.colSubtext)
                    }
                }
            }
            ...
            ColumnLayout {
                ...
                StyledText {
                    ...
                    color: Appearance.baEverywhere ? root.jiraColText : (blendedColors?.colOnLayer0 ?? Appearance.colors.colOnLayer0)
                ...
                Item {
                    ...
                    Loader {
                        ...
                        sourceComponent: StyledSlider {
                            ...
                            highlightColor: Appearance.baEverywhere ? root.jiraColPrimary : (blendedColors?.colPrimary ?? Appearance.colors.colPrimary)
                            trackColor: Appearance.baEverywhere ? Appearance.ba.colLayer2 : (blendedColors?.colSecondaryContainer ?? Appearance.colors.colSecondaryContainer)
                            handleColor: Appearance.baEverywhere ? root.jiraColPrimary : (blendedColors?.colPrimary ?? Appearance.colors.colPrimary)
                ...
                RowLayout {
                    ...
                    RippleButton {
                        ...
                        colBackgroundHover: Appearance.baEverywhere ? Appearance.ba.colLayer2Hover : ColorUtils.transparentize(blendedColors?.colLayer1 ?? Appearance.colors.colLayer1, 0.5)
                        colRipple: Appearance.baEverywhere ? Appearance.ba.colLayer2Active : (blendedColors?.colLayer1Active ?? Appearance.colors.colLayer1Active)
                    ...
                    RippleButton {
                        ...
                        colBackground: Appearance.baEverywhere
                            ? "transparent"
                        ...
                        colBackgroundHover: Appearance.baEverywhere
                        ...
                        colRipple: Appearance.baEverywhere
                        ...
                        Behavior on buttonRadius {
                            enabled: Appearance.animationsEnabled && !Appearance.baEverywhere
