...
Rectangle {
    ...
    color: cleanLayout ? "transparent" : (Appearance.baEverywhere ? Appearance.ba.colLayer1 : (Appearance.auroraEverywhere ? Appearance.aurora.colSubSurface : Appearance.colors.colLayer1))
