        ...
        Repeater {
            ...
            delegate: Item {
                ...
                Rectangle {
                    ...
                    // Subtle glow (hidden in ba style)
                    Rectangle {
                ...
                Item {
                    ...
                    Rectangle {
                        ...
                        width: 30
                        height: 22
                        radius: Appearance.baEverywhere ? Appearance.ba.roundingSmall
                        ...
                        MaterialSymbol {
                            ...
                            iconSize: 14
                            color: handleMouseArea.containsMouse || widgetWrapper.isBeingDragged
                                ? (Appearance.baEverywhere ? Appearance.ba.colOnLayer1
