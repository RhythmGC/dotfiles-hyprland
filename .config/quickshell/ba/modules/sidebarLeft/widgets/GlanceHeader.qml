...
Item {
    ...
    ColumnLayout {
        ...
        anchors.topMargin: (Appearance.angelEverywhere || Appearance.baEverywhere) ? 12 : 0
        spacing: (Appearance.angelEverywhere || Appearance.baEverywhere) ? 2 : 4
        ...
        RowLayout {
            ...
            StyledText {
                ...
                color: Appearance.baEverywhere ? Appearance.ba.colText : Appearance.colors.colOnLayer0
                animateChange: true
            }

            Item { Layout.fillWidth: true }

            // Buttons container with ba styling
            Row {
                spacing: 6
                ...
                RippleButton {
                    ...
                    colBackgroundHover: Appearance.baEverywhere ? Appearance.ba.colLayer1Hover
                    ...
                    colRipple: Appearance.baEverywhere ? Appearance.ba.colLayer1Active
                    ...
                    contentItem: Item {
                        MaterialSymbol {
                            ...
                            iconSize: 18
                            fill: 1
                            color: Appearance.baEverywhere ? Appearance.ba.colPrimary : Appearance.colors.colOnTertiaryContainer
                        }
                    }
                ...
                RippleButton {
                    ...
                    contentItem: Item {
                        MaterialSymbol {
                            ...
                            iconSize: 18
                            fill: 1
                            color: Appearance.baEverywhere ? Appearance.ba.colPrimary : Appearance.colors.colOnPrimaryContainer
                        }
                    }
                ...
                RippleButton {
                    ...
                    onClicked: {
                        ...
                        const pageIndex = isWaffle ? 6 : 5; // Modules (Waffle) vs Interface (ba)
        ...
        RowLayout {
            Layout.fillWidth: true
            Layout.bottomMargin: Appearance.baEverywhere ? 10 : 0
            spacing: 8

            StyledText {
                readonly property string _configFormat: Config.options?.time?.dateFormat ?? ""
                readonly property string _defaultFormat: Appearance.baEverywhere ? "dddd, MMMM yyyy" : "dddd, d MMMM"
