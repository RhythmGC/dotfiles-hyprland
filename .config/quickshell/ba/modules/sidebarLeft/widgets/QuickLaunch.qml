        ...
        Repeater {
            ...
            Item {
                    ...
                    contentItem: Item {
                        MaterialSymbol {
                            ...
                            color: Appearance.baEverywhere
                                ? (launchBtn.isRunning ? Appearance.ba.colPrimary : Appearance.ba.colText)
                ...
                Rectangle {
                    ...
                    anchors.topMargin: 2
                    anchors.horizontalCenter: parent.horizontalCenter
                    width: Appearance.baEverywhere ? 12 : 6
                    height: Appearance.baEverywhere ? 2 : 6
                    radius: Appearance.baEverywhere ? 1 : 3
