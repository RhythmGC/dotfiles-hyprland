...
Item {
    ...
    readonly property color colSubtext: Appearance.baEverywhere ? Appearance.ba?.colTextMuted ?? Appearance.colors?.colSubtext ?? "gray"
    ...
    readonly property color colPrimary: Appearance.baEverywhere ? Appearance.ba?.colPrimary ?? Appearance.colors?.colPrimary ?? "blue"
    ...
    readonly property color colText: Appearance.baEverywhere ? Appearance.ba?.colText ?? Appearance.colors?.colOnLayer1 ?? "white"
    ...
    readonly property color colLabel: Appearance.baEverywhere ? Appearance.ba?.colLabel ?? Appearance.colors?.colPrimary ?? "blue"
                                    : Appearance.colors?.colPrimary ?? "blue"
    readonly property color colLayer1Hover: Appearance.angelEverywhere ? Appearance.angel?.colGlassCardHover ?? Appearance.colors?.colLayer1Hover ?? "gray"
                                          : Appearance.baEverywhere ? Appearance.ba?.colLayer1Hover ?? Appearance.colors?.colLayer1Hover ?? "gray"
    ...
    readonly property color colLayer1Active: Appearance.angelEverywhere ? Appearance.angel?.colGlassCardActive ?? Appearance.colors?.colLayer1Active ?? "gray"
                                           : Appearance.baEverywhere ? Appearance.ba?.colLayer1Active ?? Appearance.colors?.colLayer1Active ?? "gray"
    ...
    readonly property color colPrimaryContainer: Appearance.baEverywhere ? Appearance.ba?.colPrimaryContainer ?? Appearance.colors?.colPrimaryContainer ?? "blue"
                                               : Appearance.colors?.colPrimaryContainer ?? "blue"
    readonly property color colPrimaryActive: Appearance.baEverywhere ? Appearance.ba?.colPrimaryActive ?? Appearance.colors?.colPrimaryContainerActive ?? "blue"
    ...
    readonly property real buttonRadius: Appearance.angelEverywhere ? Appearance.angel?.roundingSmall ?? 2
                                       : Appearance.baEverywhere ? Appearance.ba?.roundingSmall ?? Appearance.rounding?.small ?? 8
