                ...
                ListView {
                    ...
                    delegate: Item {
                        ...
                        Rectangle {
                            ...
                            border.color: Appearance.baEverywhere ? Appearance.ba.colPrimary : Appearance.colors.colPrimary
                            z: 2
                        ...
                        Rectangle {
                            ...
                            anchors.fill: parent
                            radius: Appearance.baEverywhere ? Appearance.ba.roundingSmall : Appearance.rounding.small
                            color: Appearance.baEverywhere ? Appearance.ba.colLayer2 : Appearance.colors.colLayer2
                            ...
                            Rectangle {
                                ...
                                width: 28
                                height: 28
                                radius: Appearance.baEverywhere ? Appearance.ba.roundingSmall : 14
