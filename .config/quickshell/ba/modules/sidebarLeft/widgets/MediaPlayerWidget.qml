...
Item {
    ...
    Rectangle {
        ...
        // Cover art background - subtle for ba, more transparent for aurora
        Image {
            id: bgArt
            anchors.fill: parent
            source: root.displayedArtFilePath
            ...
            asynchronous: true
            cache: false
            opacity: Appearance.angelEverywhere ? 0.2 : (Appearance.baEverywhere ? 0.15 : (Appearance.auroraEverywhere ? 0.25 : 0.5))
        ...
        RowLayout {
            ...
            Rectangle {
                ...
                Rectangle {
                    anchors.fill: parent
                    color: Appearance.angelEverywhere ? Appearance.angel.colGlassCard
                        : Appearance.baEverywhere ? root.jiraColLayer2 : (blendedColors?.colLayer1 ?? Appearance.colors.colLayer1)
                    ...
                    MaterialSymbol {
                        ...
                        color: Appearance.angelEverywhere ? Appearance.angel.colTextSecondary
                            : Appearance.baEverywhere ? root.jiraColTextSecondary : (blendedColors?.colSubtext ?? Appearance.colors.colSubtext)
                    }
                }
            }
            ...
            ColumnLayout {
                ...
                StyledText {
                    ...
                    color: Appearance.angelEverywhere ? Appearance.angel.colText
                        : Appearance.baEverywhere ? root.jiraColText : (blendedColors?.colOnLayer0 ?? Appearance.colors.colOnLayer0)
                    ...
                    Loader {
                        ...
                        sourceComponent: StyledSlider {
                            ...
                            trackColor: Appearance.angelEverywhere ? Appearance.angel.colGlassCard
                                : Appearance.baEverywhere ? Appearance.ba.colLayer2 : (blendedColors?.colSecondaryContainer ?? Appearance.colors.colSecondaryContainer)
                ...
                RowLayout {
                    ...
                    RippleButton {
                        ...
                        buttonRadius: Appearance.angelEverywhere ? Appearance.angel.roundingSmall
                            : Appearance.baEverywhere ? Appearance.ba.roundingSmall : Appearance.rounding.full
                        colBackground: "transparent"
                        colBackgroundHover: Appearance.angelEverywhere ? Appearance.angel.colGlassCardHover
                            : Appearance.baEverywhere ? Appearance.ba.colLayer2Hover : ColorUtils.transparentize(blendedColors?.colLayer1 ?? Appearance.colors.colLayer1, 0.5)
                        colRipple: Appearance.angelEverywhere ? Appearance.angel.colGlassCardActive
                            : Appearance.baEverywhere ? Appearance.ba.colLayer2Active : (blendedColors?.colLayer1Active ?? Appearance.colors.colLayer1Active)
