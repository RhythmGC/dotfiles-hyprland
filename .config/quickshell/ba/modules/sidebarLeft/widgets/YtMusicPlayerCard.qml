...
Item {
    ...
    // Style tokens
    readonly property color colText: Appearance.baEverywhere ? Appearance.ba.colText
        : (blendedColors?.colOnLayer0 ?? Appearance.colors.colOnLayer0)
    readonly property color colTextSecondary: Appearance.baEverywhere ? Appearance.ba.colTextSecondary
        : (blendedColors?.colSubtext ?? Appearance.colors.colSubtext)
    readonly property color colPrimary: Appearance.baEverywhere ? Appearance.ba.colPrimary
    ...
    readonly property color colLayer2: Appearance.baEverywhere ? Appearance.ba.colLayer2
    ...
    Rectangle {
        ...
        Image {
            ...
            asynchronous: true
            cache: false
            opacity: root.downloaded ? (Appearance.baEverywhere ? 0.15 : (Appearance.auroraEverywhere ? 0.25 : 0.5)) : 0
            visible: opacity > 0
            Behavior on opacity {
