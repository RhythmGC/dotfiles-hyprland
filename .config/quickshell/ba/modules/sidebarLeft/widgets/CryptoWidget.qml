        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                RippleButton {
                    ...
                    colBackgroundHover: Appearance.baEverywhere ? Appearance.ba.colLayer1Hover : Appearance.colors.colLayer1Hover
                    onClicked: root.fetchPrices()
                    contentItem: MaterialSymbol {
                        text: "refresh"; iconSize: 14
                        color: Appearance.baEverywhere ? Appearance.ba.colTextSecondary : Appearance.colors.colOnLayer1Inactive
                    }
            ...
            Repeater {
                ...
                RowLayout {
                    ...
                    Graph {
                        ...
                        values: row.spark
                        color: row.up ? (Appearance.baEverywhere ? Appearance.ba.colPrimary : Appearance.colors.colPrimary)
                                      : (Appearance.baEverywhere ? Appearance.ba.colError : Appearance.colors.colError)
                        fillOpacity: 0.25
            ...
            StyledText {
                ...
                font.pixelSize: Appearance.font.pixelSize.smallest
                color: Appearance.baEverywhere ? Appearance.ba.colError : Appearance.colors.colError
            }
            StyledText {
