...
Item {
    ...
    // ── Theme tokens ──────────────────────────────────────────────────
    readonly property color colText: Appearance.baEverywhere ? Appearance.ba.colText : Appearance.colors.colOnLayer1
    readonly property color colSubtext: Appearance.baEverywhere ? Appearance.ba.colTextSecondary : Appearance.colors.colSubtext
    readonly property color colPrimary: Appearance.baEverywhere ? Appearance.ba.colPrimary : Appearance.colors.colPrimary
    readonly property color colSurface: Appearance.baEverywhere ? Appearance.ba.colLayer2
        : Appearance.auroraEverywhere ? Appearance.aurora.colSubSurface
        : Appearance.colors.colLayer2
    readonly property color colSurfaceHover: Appearance.baEverywhere ? Appearance.ba.colLayer2Hover
        : Appearance.auroraEverywhere ? Appearance.aurora.colSubSurfaceHover
        : Appearance.colors.colLayer2Hover
    readonly property real radiusCard: Appearance.baEverywhere ? Appearance.ba.roundingNormal : Appearance.rounding.normal
    readonly property real radiusInner: Appearance.baEverywhere ? Appearance.ba.roundingSmall : Appearance.rounding.small
                    ...
                    RowLayout {
                        ...
                        Rectangle {
                            ...
                            color: clockRow.accentLocal
                                ...
                                : (Appearance.baEverywhere ? Appearance.ba.colLayer1 : Appearance.colors.colLayer1)
