...
RippleButton {
    ...
    readonly property real cardRadius: Appearance.baEverywhere ? Appearance.ba.roundingNormal : Appearance.rounding.normal
    readonly property real imageRadius: Appearance.baEverywhere ? Appearance.ba.roundingNormal : Appearance.rounding.small
    
    implicitHeight: compact ? 80 : 120
    Layout.fillWidth: true
    buttonRadius: cardRadius
    
    // Theming - aurora/ba/material
    ...
    contentItem: RowLayout {
        ...
        Item {
            ...
            Rectangle {
                ...
                border.color: Appearance.baEverywhere ? Appearance.ba.colBorderSubtle
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                Rectangle {
                    ...
                    color: Appearance.baEverywhere ? Appearance.ba.colPrimaryContainer
                        : Appearance.auroraEverywhere ? Appearance.aurora.colSubSurface
                    ...
                    StyledText {
                        ...
                        color: Appearance.baEverywhere ? Appearance.ba.colOnPrimaryContainer
            ...
            Flow {
                ...
                Repeater {
                    ...
                    delegate: Rectangle {
                        ...
                        radius: Appearance.rounding.verysmall
                        color: Appearance.baEverywhere ? Appearance.ba.colSecondaryContainer
                            : Appearance.auroraEverywhere ? Appearance.aurora.colSubSurface
                        ...
                        StyledText {
                            ...
                            text: modelData
                            font.pixelSize: Appearance.font.pixelSize.smallest
                            color: Appearance.baEverywhere ? Appearance.ba.colOnSecondaryContainer
