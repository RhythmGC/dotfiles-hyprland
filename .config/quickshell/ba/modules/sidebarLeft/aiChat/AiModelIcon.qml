...
/**
 * Renders a model/provider icon, transparently handling both kinds BlueArchive uses:
...
Item {
    ...
    // Theme SVG icons in BlueArchive are named "*-symbolic"; everything else is treated
    // as a Material glyph.
    ...
    CustomIcon {
        ...
        // in BlueArchive; IconImage resolves the file under assets/icons.
