...
Rectangle {
    ...
    color: Appearance.angelEverywhere ? Appearance.angel.colGlassCard
        : Appearance.baEverywhere ? Appearance.ba.colLayer2 : Appearance.auroraEverywhere ? Appearance.aurora.colElevatedSurface : Appearance.colors.colLayer2
            ...
            sourceComponent: Item {
                ...
                StyledImage {
                    ...
                    Rectangle {
                        ...
                        color: "transparent"
                        border.width: 1
                        border.color: Appearance.baEverywhere ? Appearance.ba.colBorder : Appearance.colors.colOutlineVariant
                        radius: Appearance.rounding.normal
                    }
                }
            }
