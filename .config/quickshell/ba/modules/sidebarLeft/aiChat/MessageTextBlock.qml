...
ColumnLayout {
    ...
    Repeater {
        ...
        delegate: TextArea {
            ...
            selectedTextColor: Appearance.baEverywhere ? Appearance.ba.colOnSelection : Appearance.m3colors.m3onSecondaryContainer
            selectionColor: Appearance.baEverywhere ? Appearance.ba.colSelection : Appearance.colors.colSecondaryContainer
            wrapMode: TextEdit.Wrap
            color: root.messageData?.thinking ? (Appearance.baEverywhere ? Appearance.ba.colTextSecondary : Appearance.colors.colSubtext) : (Appearance.baEverywhere ? Appearance.ba.colText : Appearance.colors.colOnLayer1)
