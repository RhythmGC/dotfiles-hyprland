...
GroupButton {
    ...
    contentItem: MaterialSymbol {
        ...
        text: buttonIcon
        color: button.activated ? (Appearance.baEverywhere ? Appearance.ba.colOnPrimary : Appearance.m3colors.m3onPrimary) :
            button.enabled ? (Appearance.baEverywhere ? Appearance.ba.colText : Appearance.m3colors.m3onSurface) :
            (Appearance.baEverywhere ? Appearance.ba.colTextDisabled : Appearance.colors.colOnLayer1Inactive)
