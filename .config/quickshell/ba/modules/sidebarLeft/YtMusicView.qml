...
Item {
    ...
    readonly property color colText: Appearance.baEverywhere ? Appearance.ba.colText : Appearance.colors.colOnLayer0
    readonly property color colTextSecondary: Appearance.baEverywhere ? Appearance.ba.colTextSecondary : Appearance.colors.colSubtext
    readonly property color colPrimary: Appearance.baEverywhere ? Appearance.ba.colPrimary : Appearance.colors.colPrimary
    readonly property color colSurface: Appearance.angelEverywhere ? Appearance.angel.colGlassCard : Appearance.baEverywhere ? Appearance.ba.colLayer1 : Appearance.auroraEverywhere ? "transparent" : Appearance.colors.colLayer1
    readonly property color colSurfaceHover: Appearance.angelEverywhere ? Appearance.angel.colGlassCardHover : Appearance.baEverywhere ? Appearance.ba.colLayer1Hover : Appearance.auroraEverywhere ? Appearance.aurora.colSubSurfaceHover : Appearance.colors.colLayer1Hover
    readonly property color colLayer2: Appearance.angelEverywhere ? Appearance.angel.colGlassElevated : Appearance.baEverywhere ? Appearance.ba.colLayer2 : Appearance.auroraEverywhere ? Appearance.aurora.colSubSurface : Appearance.colors.colLayer2
    readonly property color colLayer2Hover: Appearance.angelEverywhere ? Appearance.angel.colGlassCardHover : Appearance.baEverywhere ? Appearance.ba.colLayer2Hover : Appearance.auroraEverywhere ? Appearance.aurora.colSubSurfaceHover : Appearance.colors.colLayer2Hover
    readonly property color colBorder: Appearance.angelEverywhere ? Appearance.angel.colCardBorder : Appearance.baEverywhere ? Appearance.ba.colBorder : "transparent"
    readonly property int borderWidth: Appearance.angelEverywhere ? Appearance.angel.cardBorderWidth : Appearance.baEverywhere ? 1 : 0
    readonly property real radiusSmall: Appearance.angelEverywhere ? Appearance.angel.roundingSmall : Appearance.baEverywhere ? Appearance.ba.roundingSmall : Appearance.rounding.small
    readonly property real radiusNormal: Appearance.angelEverywhere ? Appearance.angel.roundingNormal : Appearance.baEverywhere ? Appearance.ba.roundingNormal : Appearance.rounding.normal
    ...
    Popup {
        ...
        background: Rectangle {
            color: Appearance.baEverywhere ? Appearance.ba.colLayer2
    ...
    component SearchView: ColumnLayout {
        ...
        Rectangle {
            Layout.fillWidth: true
            implicitHeight: 42
            radius: Appearance.baEverywhere ? root.radiusSmall : Appearance.rounding.full
            color: root.colLayer2
            border.width: root.borderWidth
            border.color: root.colBorder
            ...
            delegate: Item {
                ...
                RowLayout {
                    ...
                    Rectangle {
                        ...
                        visible: Appearance.baEverywhere
                    }
                }
