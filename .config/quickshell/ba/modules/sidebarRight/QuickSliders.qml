...
Rectangle {
    ...
    border.width: root.compactSurface ? 0 : (Appearance.angelEverywhere ? 0 : (Appearance.baEverywhere ? 1 : 0))
        ...
        MaterialSymbol {
            ...
            color: nearFull
                ...
                : (Appearance.angelEverywhere ? Appearance.angel.colText
                 : Appearance.baEverywhere ? Appearance.ba.colOnSecondaryContainer
