...
GroupButton {
    ...
    colBackgroundToggled: Appearance.angelEverywhere ? ColorUtils.transparentize(Appearance.angel.colPrimary, 0.45)
        : Appearance.baEverywhere ? Appearance.ba.colPrimaryContainer : Appearance.colors.colPrimary
    colBackgroundToggledHover: Appearance.angelEverywhere ? ColorUtils.transparentize(Appearance.angel.colPrimaryHover, 0.35)
        : Appearance.baEverywhere ? Appearance.ba.colPrimaryContainerHover : Appearance.colors.colPrimaryHover
    ...
    contentItem: Item {
        ...
        MaterialSymbol {
            ...
            color: Appearance.angelEverywhere
                ...
                ? (button.toggled ? Appearance.ba.colOnPrimaryContainer : Appearance.ba.colText)
