...
// metrics · air quality. Family-aware tokens (material / aurora / ba / angel).
Item {
    id: root
    ...
    readonly property real cardRadius: ba ? Appearance.ba.roundingNormal
    ...
    component Card: Rectangle {
        ...
        color: root.colCard
        border.width: (root.angel || root.ba) ? 1 : 0
