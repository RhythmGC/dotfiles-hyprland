...
Item {
    ...
    readonly property color colError: Appearance.angelEverywhere ? Appearance.angel.colError
        : Appearance.baEverywhere ? (Appearance.ba?.colError ?? Appearance.m3colors.m3error)
        : Appearance.m3colors.m3error
    readonly property color colBadge: Appearance.angelEverywhere ? Appearance.angel.colBorderSubtle
        : Appearance.baEverywhere ? ColorUtils.transparentize(Appearance.ba.colBorder, 0.5)
    ...
    Rectangle {
        ...
        color: {
            if (editMA.containsMouse && !root.isExternal) {
                ...
                if (Appearance.baEverywhere) return Appearance.ba.colLayer2Hover
            ...
            if (Appearance.baEverywhere) return Appearance.ba.colLayer2
