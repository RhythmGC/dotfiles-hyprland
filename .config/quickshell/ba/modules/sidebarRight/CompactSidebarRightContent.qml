...
//
// Fully compatible with all global styles: material, aurora, ba, angel.
...
Item {
        ...
        Item {
            ...
            ColumnLayout {
                ...
                Item {
                    ...
                    readonly property color _colText: bg.baEverywhere ? Appearance.ba.colText
                        : bg.angelEverywhere ? Appearance.angel.colText
                        : Appearance.colors.colOnLayer1
                    readonly property color _colSub: bg.baEverywhere ? Appearance.ba.colTextSecondary
                        : bg.angelEverywhere ? Appearance.angel.colTextSecondary
                        : Appearance.colors.colSubtext
                    readonly property color _colPrimary: bg.baEverywhere ? Appearance.ba.colPrimary
    ...
    component ControlChipButton: Item {
        ...
        Rectangle {
            ...
            radius: bg.angelEverywhere ? Appearance.angel.roundingSmall
                : bg.baEverywhere ? Appearance.ba.roundingSmall
                : Appearance.rounding.small
            color: {
                if (chipMA.containsPress)
                    return bg.baEverywhere ? Appearance.ba.colLayer2Active
                        : bg.angelEverywhere ? Appearance.angel.colGlassCardActive
                        : bg.colDarkSurfaceActive
                if (chipMA.containsMouse)
                    return bg.baEverywhere ? Appearance.ba.colLayer2Hover
    ...
    StyledRectangularShadow {
        target: bg
        visible: !Appearance.baEverywhere && !Appearance.gameModeMinimal
    }
    ...
    Rectangle {
        ...
        readonly property color colDarkSurface: angelEverywhere
            ...
            : baEverywhere ? ColorUtils.transparentize(Appearance.ba.colLayer1, 0.22)
        ...
        readonly property color colDarkSurfaceHover: angelEverywhere
            ...
            : baEverywhere ? Appearance.ba.colLayer2Hover
            : auroraEverywhere ? ColorUtils.transparentize(
        ...
        readonly property color colDarkSurfaceActive: angelEverywhere
            ...
            : baEverywhere ? Appearance.ba.colLayer2Active
            : auroraEverywhere ? ColorUtils.transparentize(
                (blendedColors?.colLayer1 ?? Appearance.colors.colLayer1),
        ...
        color: gameModeMinimal  ? "transparent"
             : baEverywhere   ? (cardStyle ? Appearance.ba.colLayer1 : Appearance.ba.colLayer0)
        ...
        border.color: angelEverywhere  ? Appearance.angel.colPanelBorder
                    : baEverywhere   ? Appearance.ba.colBorder
                    : Appearance.colors.colLayer0Border

        radius: angelEverywhere  ? Appearance.angel.roundingNormal
              : baEverywhere   ? (cardStyle ? Appearance.ba.roundingLarge : Appearance.ba.roundingNormal)
        ...
        ColumnLayout {
            ...
            anchors.topMargin: Appearance.angelEverywhere ? root.compactPanelPadding + 4
                : Appearance.baEverywhere ? root.compactPanelPadding + 6 : root.compactPanelPadding
            spacing: Appearance.angelEverywhere ? root.compactPanelPadding + 2
                : Appearance.baEverywhere ? root.compactPanelPadding + 4 : root.compactPanelPadding
            ...
            Rectangle {
                ...
                Layout.fillHeight: true
                radius: bg.angelEverywhere ? Appearance.angel.roundingNormal
                    : bg.baEverywhere ? Appearance.ba.roundingNormal : Appearance.rounding.normal
                color: bg.angelEverywhere ? Appearance.angel.colGlassCard
                    : bg.baEverywhere ? Appearance.ba.colLayer1
                ...
                border.color: bg.angelEverywhere ? Appearance.angel.colCardBorder
                    : bg.baEverywhere ? Appearance.ba.colBorder : "transparent"
                clip: true
            ...
            Rectangle {
                ...
                Rectangle {
                    ...
                    color: bg.angelEverywhere  ? ColorUtils.transparentize(Appearance.angel.colCardBorder,  0.62)
                         : bg.baEverywhere   ? ColorUtils.transparentize(Appearance.ba.colBorder, 0.45)
                         : bg.auroraEverywhere ? ColorUtils.transparentize(Appearance.colors.colOutlineVariant, 0.78)
                         : ColorUtils.transparentize(Appearance.colors.colOutlineVariant, 0.72)
                }
                ...
                Rectangle {
                    ...
                    radius: bg.angelEverywhere ? Appearance.angel.roundingSmall
                          : bg.baEverywhere  ? Appearance.ba.roundingSmall
                          : Appearance.rounding.small
                    color: bg.baEverywhere  ? Appearance.ba.colSecondaryContainer
                    ...
                    border.color: bg.angelEverywhere ? ColorUtils.transparentize(Appearance.angel.colCardBorder, 0.38)
                        : bg.baEverywhere ? ColorUtils.transparentize(Appearance.ba.colBorder, 0.36)
                ...
                Rectangle {
                    ...
                    height: 26
                    radius: 2
                    color: bg.baEverywhere  ? Appearance.ba.colPrimary
                         : bg.angelEverywhere ? Appearance.angel.colPrimary
                         : Appearance.colors.colPrimary
                    visible: false
                ...
                ColumnLayout {
                        ...
                        delegate: Item {
                            ...
                            Rectangle {
                                ...
                                border.color: bg.angelEverywhere ? ColorUtils.transparentize(Appearance.angel.colCardBorder, 0.42)
                                    : bg.baEverywhere ? ColorUtils.transparentize(Appearance.ba.colBorder, 0.34)
                                ...
                                MaterialSymbol {
                                    ...
                                    color: navItem.isActive
                                        ? (bg.baEverywhere  ? Appearance.ba.colOnSecondaryContainer
                                         : bg.angelEverywhere ? Appearance.angel.colOnPrimary
                                         : Appearance.m3colors.m3onSecondaryContainer)
                                        : (bg.baEverywhere  ? Appearance.ba.colTextSecondary
                                         : bg.angelEverywhere ? Appearance.angel.colTextSecondary
                                         : Appearance.colors.colOnLayer1)
                                    Behavior on color { enabled: Appearance.animationsEnabled; ColorAnimation { duration: Appearance.animation.elementMoveFast.duration } }
                                }
                                ...
                                Rectangle {
                                    ...
                                    StyledText {
                                        ...
                                        color: bg.baEverywhere  ? Appearance.ba.colOnPrimary
                                             : bg.angelEverywhere ? Appearance.angel.colOnPrimary
                    ...
                    Rectangle {
                        ...
                        color: bg.angelEverywhere  ? ColorUtils.transparentize(Appearance.angel.colCardBorder, 0.68)
                             : bg.baEverywhere   ? ColorUtils.transparentize(Appearance.ba.colBorder, 0.5)
                        ...
                        delegate: Item {
                            ...
                            Rectangle {
                                ...
                                MaterialSymbol {
                                    ...
                                    color: bg.baEverywhere  ? Appearance.ba.colTextSecondary
                                         : bg.angelEverywhere ? Appearance.angel.colTextSecondary
                                         : Appearance.colors.colOnLayer1
                                }
                                MouseArea {
                        ...
                        delegate: ColumnLayout {
                            ...
                            RowLayout {
                                ...
                                RippleButton {
                                    ...
                                    colBackgroundHover: bg.baEverywhere ? Appearance.ba.colLayer1Hover
                                        : bg.angelEverywhere ? Appearance.angel.colGlassCardHover
                                        : Appearance.colors.colLayer1Hover
                                    onClicked: root.moveSectionUp(sectionDelegate.index)
                                    contentItem: MaterialSymbol { anchors.centerIn: parent; text: "arrow_upward"; iconSize: 16; color: bg.baEverywhere ? Appearance.ba.colText : bg.angelEverywhere ? Appearance.angel.colText : Appearance.colors.colOnLayer1 }
                                ...
                                RippleButton {
                                    ...
                                    contentItem: MaterialSymbol { anchors.centerIn: parent; text: "arrow_downward"; iconSize: 16; color: bg.baEverywhere ? Appearance.ba.colText : bg.angelEverywhere ? Appearance.angel.colText : Appearance.colors.colOnLayer1 }
                                ...
                                sourceComponent: ColumnLayout {
                                    ...
                                    Item {
                                        ...
                                        Rectangle {
                                            ...
                                            radius: bg.angelEverywhere ? Appearance.angel.roundingNormal : bg.baEverywhere ? Appearance.ba.roundingNormal : Appearance.rounding.normal
                                            color: bg.angelEverywhere ? Appearance.angel.colGlassCard
                                                : bg.baEverywhere ? Appearance.ba.colLayer1
                                                : "transparent"
                                            border.width: 0
    ...
    function doSettings() {
        ...
        if (CompositorService.isNiri) {
            ...
            for (let i = 0; i < wins.length; i++) {
                const w = wins[i]
                if (w.title === "baOS Settings" && w.app_id === "org.quickshell") {
        ...
        GlobalStates.sidebarRightOpen = false
        Qt.callLater(() => Quickshell.execDetached([Quickshell.shellPath("scripts/ba"), "settings"]))
    }
    ...
    component SectionHeader: Item {
        ...
        RowLayout {
            ...
            StyledText {
                ...
                font.pixelSize: Appearance.font.pixelSize.small
                font.weight: Font.Medium
                color: bg.baEverywhere  ? Appearance.ba.colText
                     : bg.angelEverywhere ? Appearance.angel.colText
            ...
            Revealer {
                ...
                Rectangle {
                    ...
                    StyledText {
                        ...
                        font.weight: Font.Bold
                        font.family: Appearance.font.family.numbers
                        color: bg.baEverywhere  ? Appearance.ba.colOnSecondaryContainer
                             : bg.angelEverywhere ? Appearance.angel.colOnPrimary
                             : Appearance.m3colors.m3onSecondaryContainer
                    }
                }
            ...
            RippleButton {
                ...
                buttonRadius: bg.angelEverywhere ? Appearance.angel.roundingSmall
                    : bg.baEverywhere ? Appearance.ba.roundingSmall : 14
                colBackground: bg.baEverywhere ? ColorUtils.transparentize(Appearance.ba.colLayer1, 0.35)
                ...
                colBackgroundHover: bg.angelEverywhere ? Appearance.angel.colGlassCardHover
                    : bg.baEverywhere ? Appearance.ba.colLayer1Hover
                    : Appearance.colors.colLayer1Hover
            ...
            RippleButton {
                ...
                colBackground: sectionHeader.actionToggled
                    ? (bg.baEverywhere ? Appearance.ba.colSecondaryContainer
                     : bg.angelEverywhere ? ColorUtils.transparentize(Appearance.angel.colPrimary, 0.60)
                     : Appearance.colors.colSecondaryContainer)
                    : (bg.baEverywhere ? ColorUtils.transparentize(Appearance.ba.colLayer1, 0.35)
                     : bg.angelEverywhere ? ColorUtils.transparentize(Appearance.angel.colGlassCard, 0.72)
                     : bg.auroraEverywhere ? bg.colDarkSurface
                     : ColorUtils.transparentize(Appearance.colors.colLayer1, 0.68))
                colBackgroundHover: bg.angelEverywhere ? Appearance.angel.colGlassCardHover
        ...
        ColumnLayout {
            ...
            RippleButton {
                ...
                colBackgroundHover: Notifications.silent
                    ? (bg.baEverywhere ? Appearance.ba.colSecondaryContainerHover
                ...
                colRipple: Notifications.silent
                    ? (bg.baEverywhere ? Appearance.ba.colSecondaryContainerActive
                        : bg.angelEverywhere ? Appearance.angel.colPrimaryActive
                        : Appearance.colors.colSecondaryContainerActive)
                    : (bg.baEverywhere ? Appearance.ba.colLayer1Active
                        : bg.angelEverywhere ? Appearance.angel.colGlassCardActive
                        : bg.colDarkSurfaceActive)
                    ...
                    StyledText {
                        ...
                        color: Notifications.silent
                            ? (bg.baEverywhere ? Appearance.ba.colOnSecondaryContainer
                                : bg.angelEverywhere ? Appearance.angel.colOnPrimary
                                : Appearance.m3colors.m3onSecondaryContainer)
                            : (bg.baEverywhere ? Appearance.ba.colText
                                : bg.angelEverywhere ? Appearance.angel.colText
                                : Appearance.colors.colOnLayer1)
                    }
                }
    ...
    component QuickActionsSection: ColumnLayout {
        ...
        GridLayout {
            ...
            QuickActionButton {
                ...
                onClicked: {
                    GlobalStates.sidebarRightOpen = false
                    Qt.callLater(() => Quickshell.execDetached([Quickshell.shellPath("scripts/ba"), "region", "screenshot"]))
                }
            }
            ...
            QuickActionButton {
                ...
                onClicked: {
                    GlobalStates.sidebarRightOpen = false
                    Qt.callLater(() => Quickshell.execDetached([Quickshell.shellPath("scripts/ba"), "region", "record"]))
                }
            }
            ...
            QuickActionButton {
                ...
                onClicked: {
                    GlobalStates.sidebarRightOpen = false
                    Qt.callLater(() => Quickshell.execDetached([Quickshell.shellPath("scripts/ba"), "region", "ocr"]))
                }
            }
            ...
            QuickActionButton {
                ...
                onClicked: {
                    GlobalStates.sidebarRightOpen = false
                    Qt.callLater(() => Quickshell.execDetached([Quickshell.shellPath("scripts/ba"), "region", "search"]))
                }
            }
        ...
        contentItem: Item {
            ...
            Rectangle {
                ...
                color: bg.angelEverywhere ? Appearance.angel.colPrimary
                    : bg.baEverywhere ? Appearance.ba.colPrimary
                    : Appearance.colors.colPrimary
                ...
                StyledText {
                    ...
                    color: bg.angelEverywhere ? Appearance.angel.colOnPrimary
                        : bg.baEverywhere ? Appearance.ba.colOnPrimary
                        : Appearance.colors.colOnPrimary
    ...
    component QuickActionButton: Item {
        ...
        readonly property color _colText: bg.baEverywhere ? Appearance.ba.colText
            : bg.angelEverywhere ? Appearance.angel.colText
            : Appearance.colors.colOnLayer1
        readonly property color _colOnToggle: bg.baEverywhere ? Appearance.ba.colOnSecondaryContainer
            : bg.angelEverywhere ? Appearance.angel.colOnPrimary
            : Appearance.m3colors.m3onSecondaryContainer
        readonly property color _colToggleBg: bg.baEverywhere ? Appearance.ba.colSecondaryContainer
