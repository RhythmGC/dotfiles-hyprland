...
Rectangle {
    ...
    function incrementTab() {
        ...
        var next = (selectedTab + 1) % tabs.length
        Persistent.states.sidebar.bottomGroup.tab = next
    }

    function decrementTab() {
        if (tabs.length === 0) return
        var prev = (selectedTab - 1 + tabs.length) % tabs.length
        Persistent.states.sidebar.bottomGroup.tab = prev
    }
    ...
    RowLayout {
        ...
        Item {
            ...
            Rectangle {
                ...
                gradient: Gradient {
                    GradientStop { position: 0.0; color: Appearance.angelEverywhere ? Appearance.angel.colGlassCard : Appearance.baEverywhere ? Appearance.ba.colLayer1 : Appearance.colors.colLayer1 }
            ...
            Rectangle {
                ...
                gradient: Gradient {
                    ...
                    GradientStop { position: 1.0; color: Appearance.angelEverywhere ? Appearance.angel.colGlassCard : Appearance.baEverywhere ? Appearance.ba.colLayer1 : Appearance.colors.colLayer1 }
                }
            }
        }
