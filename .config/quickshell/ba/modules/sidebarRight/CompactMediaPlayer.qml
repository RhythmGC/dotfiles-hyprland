...
// Compatible with all 5 global styles: material, cards, aurora, ba, angel
...
Item {
    ...
    readonly property color colText: angelStyle ? Appearance.angel.colText
        : baStyle ? Appearance.ba.colText : Appearance.colors.colOnLayer1
    readonly property color colTextSecondary: angelStyle ? Appearance.angel.colTextSecondary
        : baStyle ? Appearance.ba.colTextSecondary : Appearance.colors.colSubtext
    ...
    readonly property color colAuxActive: angelStyle ? Appearance.angel.colGlassCardActive
        : baStyle ? Appearance.ba.colLayer2Active
        : ColorUtils.transparentize(root.colText, 0.72)

    // Dynamic accent from album art
    readonly property color accentColor: playerBase.downloaded && !baStyle && !angelStyle
        ? (blendedColors?.colPrimary ?? colPrimary) : colPrimary
    readonly property color onAccentColor: playerBase.downloaded && !baStyle && !angelStyle
        ? (blendedColors?.colOnPrimary ?? colOnPrimary) : colOnPrimary

    // Art background opacity per style
    readonly property real artBgOpacity: baStyle ? 0.16
        ...
        ColumnLayout {
                    ...
                    Item {
                        ...
                        PlayerArtwork {
                            ...
                            artRadius: root.angelStyle ? Appearance.angel.roundingSmall
                                : root.baStyle ? Appearance.ba.roundingSmall
            ...
            PlayerProgress {
                ...
                trackColor: root.angelStyle ? Appearance.angel.colBorderSubtle
                    : root.baStyle ? ColorUtils.transparentize(Appearance.ba.colBorder, 0.5)
    ...
    component TransportBtn: Item {
        ...
        Rectangle {
            ...
            color: {
                ...
                if (tBtn.toggled)
                    return root.angelStyle
                        ...
                        : root.baStyle ? Appearance.ba.colSecondaryContainer
            ...
            MaterialSymbol {
                ...
                animateFill: true
                color: tBtn.toggled
                    ? (root.baStyle ? Appearance.ba.colOnSecondaryContainer
                        : root.accentColor)
