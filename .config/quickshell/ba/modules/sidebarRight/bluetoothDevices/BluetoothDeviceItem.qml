...
DialogListItem {
    ...
    component ActionButton: DialogButton {
        ...
        colText: Appearance.baEverywhere ? Appearance.ba.colOnPrimary : Appearance.colors.colOnPrimary
    }
    ...
    contentItem: ColumnLayout {
        ...
        RowLayout {
            ...
            MaterialSymbol {
                ...
                color: Appearance.baEverywhere ? Appearance.ba.colTextSecondary : Appearance.colors.colOnSurfaceVariant
            }
            ...
            ColumnLayout {
                ...
                StyledText {
                    Layout.fillWidth: true
                    color: Appearance.baEverywhere ? Appearance.ba.colText : Appearance.colors.colOnSurfaceVariant
            ...
            MaterialSymbol {
                ...
                iconSize: Appearance.font.pixelSize.larger
                color: Appearance.baEverywhere ? Appearance.ba.colTextSecondary : Appearance.colors.colOnLayer3
