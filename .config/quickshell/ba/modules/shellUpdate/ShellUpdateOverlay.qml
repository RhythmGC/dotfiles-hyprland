...
Scope {
    ...
    readonly property real pillRadius: Appearance.angelEverywhere ? Appearance.angel.roundingSmall
        : Appearance.baEverywhere ? Appearance.ba.roundingSmall : 999
    ...
    PanelWindow {
        ...
        Item {
            ...
            MultiEffect {
                ...
                blurEnabled: Appearance.effectsEnabled && !Appearance.baEverywhere
                blur: (Appearance.effectsEnabled && !Appearance.baEverywhere) ? 1.0 : 0
                blurMax: 64
                blurMultiplier: 1.0
                saturation: (Appearance.effectsEnabled && !Appearance.baEverywhere) ? 0.2 : 0
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    Rectangle {
                        ...
                        border.color: Appearance.baEverywhere ? root.borderColor : "transparent"
                        ...
                        RippleButton {
                            ...
                            onClicked: {
                                ...
                                Notifications.notify({
                                    ...
                                    body: "Diagnostics printed to console. Run: qs log -c ba | tail -50",
                                    ...
                                    ColumnLayout {
                                        ...
                                        Repeater {
                                            ...
                                            Rectangle {
                                                ...
                                                radius: Appearance.baEverywhere ? 2 : (Appearance.rounding?.smaller ?? 4)
                                                color: index % 2 === 0
                                                    ? "transparent"
