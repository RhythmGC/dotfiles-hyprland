...
ApplicationWindow {
    ...
    property var settingsSearchIndex: [
        ...
        // =====================================================================
        {
            ...
            description: Translation.tr("Material, Cards, Aurora glass effect, Ba TUI style"),
            keywords: ["global", "style", "aurora", "ba", "material", "cards", "glass", "tui", "transparency", "blur"]
        },
        {
            pageIndex: 4, pageName: pages[4].name,
            section: Translation.tr("Global Style"),
        ...
        },
        {
            pageIndex: 4, pageName: pages[4].name,
            section: Translation.tr("Global Style"),
            label: Translation.tr("Ba"),
            description: Translation.tr("TUI-inspired style with accent borders"),
            keywords: ["ba", "tui", "terminal", "borders", "style", "minimal"]
        },
        {
            pageIndex: 4, pageName: pages[4].name,
            section: Translation.tr("Global Style"),
        ...
        // =====================================================================
        {
            ...
            description: Translation.tr("Niri and ba keybindings reference"),
                ...
                Flickable {
                    ...
                    NavigationRail {
                        ...
                        FloatingActionButton {
                            ...
                            downAction: () => {
                                Qt.openUrlExternally(`${Directories.config}/baOS/config.json`);
                            }
                            altAction: () => {
                                Quickshell.clipboardText = CF.FileUtils.trimFileProtocol(`${Directories.config}/baOS/config.json`);
                                fab.justCopied = true;
                ...
                Rectangle {
                    ...
                    Rectangle {
                        ...
                        GlassBackground {
                            ...
                            baColor: Appearance.ba.colLayer2
