...
/**
 * Keybinds for Niri compositor with BlueArchive shell.
...
Singleton {
    ...
    readonly property var defaultKeybinds: [
        ...
        {
            name: "BlueArchive Shell",
            children: [{ keybinds: [
                { mods: ["Super"], key: "Space", comment: "BlueArchive Overview" },
                { mods: ["Super"], key: "G", comment: "BlueArchive Overlay" },
