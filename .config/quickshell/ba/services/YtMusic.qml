...
Singleton {
    ...
    Process {
        id: _oauthDeleteProc
        command: ["/bin/sh", "-c", "rm -f \"${XDG_CONFIG_HOME:-$HOME/.config}/baOS/ytmusic_oauth.json\""]
    }
...
`]
    ...
    // Handles processes that survived across ba restart or weren't cleaned up properly.
    Process {
