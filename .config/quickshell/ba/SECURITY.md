...
2. Use [GitHub's private vulnerability reporting](https://github.com/RhythmGC/dotfiles-hyprland/security/advisories/new).
...
BlueArchive is a desktop shell that runs with user-level permissions. Security concerns include:
...
Out of scope: compositor vulnerabilities (Niri/Hyprland), Qt/Quickshell framework bugs, and system-level privilege escalation (BlueArchive never runs as root).
