...
BlueArchive आपका पूरा डेस्कटॉप है। ऊपर की बार, डॉक, नोटिफिकेशन, सेटिंग्स, वॉलपेपर, सब कुछ। ये थीम नहीं है, कॉपी-पेस्ट करने वाली dotfiles नहीं है। Linux पर चलने वाला एक पूरा शेल है।

### चलाने के लिए क्या चाहिए?

एक compositor। ये वो चीज़ है जो विंडोज़ को मैनेज करती है और स्क्रीन पर पिक्सल्स डालती है। BlueArchive [Niri](https://github.com/YaLTeR/niri) (एक tiling Wayland compositor) के लिए बना है। end-4 के dots से फोर्क होने के समय का पुराना Hyprland कोड है, लेकिन असल में टेस्ट और इस्तेमाल Niri होता है।
...
आपकी apps
   ↓
BlueArchive (शेल: बार, साइडबार, डॉक, नोटिफिकेशन, सेटिंग्स...)
   ↓
...
कुछ काम नहीं करे तो `ba doctor` ज़्यादातर ठीक कर देता है। वो भी नहीं हुआ तो Discord active है। polished software की उम्मीद मत रखो, ये एक आदमी का rice है जो दूसरों को पसंद आ गया।
...
- **QML**: Qt की declarative UI भाषा, BlueArchive इसमें लिखा है
- **Material You**: Google का color system जो इमेज से palette बनाता है (auto-theming ऐसे काम करता है)
- **ba / waffle**: दो panel styles। ba = Material Design वाइब, waffle = Windows 11 वाइब। `Super+Shift+W` से switch करो
...
<details open>
<summary><b>Material ba</b> — फ़्लोटिंग बार, साइडबार, Material Design सौंदर्य</summary>
...
- **Material ba** — फ़्लोटिंग बार, साइडबार, डॉक, 5 विज़ुअल स्टाइल (material, cards, aurora, ba, angel)
...
- **5 विज़ुअल स्टाइल** — Material (ठोस), Cards, Aurora (ग्लास ब्लर), BlueArchive (TUI-प्रेरित), Angel (नव-ब्रूटलिज़्म)
...
- **ऑटो-अपडेट** — `ba update`, रोलबैक, माइग्रेशन, और उपयोगकर्ता परिवर्तन संरक्षण के साथ
...
इंस्टॉलर डिपेंडेंसी, सिस्टम कॉन्फ़िग, थीमिंग — सब संभालता है। इंस्टॉल के बाद `ba run` चलाएँ, या लॉगआउट करके वापस लॉगिन करें।

```bash
ba run                        # शेल शुरू करें
ba settings                   # सेटिंग्स GUI खोलें
ba logs                       # रनटाइम लॉग देखें
ba doctor                     # ऑटो-डायग्नोस और ठीक करें
ba update                     # pull + माइग्रेशन + रीस्टार्ट
```
...
| तरीक़ा | कमांड |
|--------|---------|
| सिस्टम इंस्टॉल | `sudo make install && ba run` |
| TUI मेन्यू | `./setup` |
...
15 वॉलपेपर शामिल हैं। और चाहिए तो [BlueArchive wallpapers](https://github.com/RhythmGC/dotfiles-hyprland/tree/main/.config/quickshell/ba/defaults) देखें — Material You पाइपलाइन के साथ अच्छा काम करने वाला एक क्यूरेटेड कलेक्शन।
...
```bash
ba logs                       # हाल के रनटाइम लॉग देखें
ba restart                    # सक्रिय रनटाइम रीस्टार्ट करें
ba repair                     # doctor + रीस्टार्ट + फ़िल्टर्ड लॉग जाँच
...
- [**end-4**](https://github.com/end-4/dots-hyprland) — Hyprland के लिए मूल baOS
...
<p align="center">
  <a href="https://github.com/RhythmGC/dotfiles-hyprland/graphs/contributors">योगदानकर्ता</a> &bull;
