...
BlueArchive is built for Niri. Secondary Hyprland support is maintained from the project's origins as a fork of end-4's Hyprland dots.
...
BlueArchive manages Niri's config through modular KDL files in `~/.config/niri/config.d/`:
