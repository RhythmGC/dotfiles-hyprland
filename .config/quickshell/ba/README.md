<p align="center">
  <img src="assets/icons/baOS.svg" alt="BlueArchive" width="800">
</p>
...
BlueArchive is your entire desktop. The bar at the top, the dock, notifications, settings, wallpapers, all of it. Not a theme, not dotfiles you paste. A full shell that runs on Linux.

### What do I need to run it?

A compositor. That's the thing that handles your windows and puts pixels on screen. BlueArchive is made for [Niri](https://github.com/YaLTeR/niri) (a tiling Wayland compositor). This checkout is maintained by RhythmGC for Hyprland; Niri integration remains available.
...
your apps
   ↓
BlueArchive (shell: bar, sidebars, dock, notifications, settings...)
   ↓
...
If something doesn't work, `ba doctor` fixes most things. Discord is active if that doesn't help. Just don't expect polished software, this is one person's rice that others happen to like.
...
- **QML**: Qt's declarative UI language, what BlueArchive is written in
- **Material You**: Google's color system that makes palettes from images (that's the auto-theming)
- **ba / waffle**: the two panel styles. ba = Material Design vibes, waffle = Windows 11 vibes. `Super+Shift+W` switches between them
...
<details open>
<summary><b>Material ba</b> — floating bar, sidebars, Material Design aesthetic</summary>

| | |
|:---:|:---:|
| ![](https://github.com/user-attachments/assets/1fe258bc-8aec-4fd9-8574-d9d7472c3cc8) | ![](https://github.com/user-attachments/assets/3ce2055b-648c-45a1-9d09-705c1b4a03b7) |
| ![](https://github.com/user-attachments/assets/ea2311dc-769e-44dc-a46d-37cf8807d2cc) | ![](assets/icons/baOS.svg) |
...
- **Material ba** — floating bar, sidebars, dock, 5 visual styles (material, cards, aurora, ba, angel)
...
- **5 visual styles** — Material (solid), Cards, Aurora (glass blur), BlueArchive (TUI-inspired), Angel (neo-brutalism)
...
- **Auto-updates** — `ba update` with rollback, migrations, and user change preservation
...
The installer handles dependencies, system config, theming — everything. After install, run `ba run` to start the shell, or log out and back in.

```bash
ba run                        # launch the shell
ba settings                   # open settings GUI
ba logs                       # check runtime logs
ba doctor                     # auto-diagnose and fix
ba update                     # pull + migrate + restart
```
...
| Method | Command |
|--------|---------|
| System install | `sudo make install && ba run` |
| TUI menu | `./setup` |
...
15 wallpapers ship bundled. For more, check [BlueArchive wallpapers](https://github.com/RhythmGC/dotfiles-hyprland/tree/main/.config/quickshell/ba/assets/wallpapers) — a curated collection that works well with the Material You pipeline.
...
```bash
ba logs                       # check recent runtime logs
...
- [**end-4**](https://github.com/end-4/dots-hyprland): original shell for Hyprland
...
<p align="center">
  <a href="https://github.com/RhythmGC/dotfiles-hyprland/graphs/contributors">Contributors</a> &bull;
