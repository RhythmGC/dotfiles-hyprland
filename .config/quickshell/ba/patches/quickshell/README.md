...
that fix issues affecting BlueArchive.  Apply them when building QS from source or
via the AUR.
...
uninstantiated components at reload time.  BlueArchive's panel family system (ba vs
