...
4. Test: `ba restart && ba logs | tail -50`
...
```bash
ba restart                    # Restart the running shell
...
Five styles with priority **angel > ba > aurora > material**:
...
- `modules/common/Appearance.qml` — all ba module visuals
...
- [Issue tracker](https://github.com/RhythmGC/dotfiles-hyprland/issues)
