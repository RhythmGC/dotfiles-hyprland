...
Scope {
    ...
    Variants {
        ...
        PanelWindow {
            ...
            // Keyboard focus only on the monitor that should show (OnDemand instead of Exclusive for drag compatibility)
            ...
            Connections {
                ...
                function onOverviewOpenChanged() {
                    ...
                    if (!GlobalStates.overviewOpen) {
                        ...
                        grab.active = false; // Release pointer grab immediately when closed
                    } else {
            ...
            Column {
                ...
                anchors {
                    ...
                    topMargin: {
                        ...
                        return barOffset + 12; // Position it at the top, 12px below the bar/dock
                    }
                }
                spacing: -8
