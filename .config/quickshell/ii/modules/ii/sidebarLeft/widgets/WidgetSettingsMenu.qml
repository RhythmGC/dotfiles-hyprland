        ...
        GlassBackground {
            ...
            ColumnLayout {
                ...
                WidgetSwitch {
                    ...
                    buttonIcon: "schedule"
                    checked: Config.options?.sidebar?.widgets?.clock ?? true
                    onClicked: Config.setNestedValue("sidebar.widgets.clock", checked)
                }

                WidgetSwitch {
                    text: Translation.tr("Notes")
                    buttonIcon: "edit_note"
                    checked: Config.options?.sidebar?.widgets?.notes ?? true
                    onClicked: Config.setNestedValue("sidebar.widgets.notes", checked)
                }
