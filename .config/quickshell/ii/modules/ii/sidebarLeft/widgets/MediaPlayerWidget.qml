...
Item {
    ...
    // Cava visualizer - using shared Item component
    Item {
        id: cavaProcess
        property bool active: root.visible && root.hasPlayer && GlobalStates.sidebarLeftOpen && Appearance.effectsEnabled
    }
    ...
    Item {
        id: artworkResolver
        property string sourceUrl: root.effectiveArtUrl
        property string title: root.effectiveTitle
        property string artist: root.effectiveArtist
        property string album: root.player?.trackAlbum ?? ""
        property string cacheDirectory: root.artDownloadLocation
        
        property bool ready: sourceUrl !== ""
        property string displaySource: sourceUrl
        function refresh() {}
    }
        ...
        RowLayout {
            ...
            ColumnLayout {
                ...
                Item {
                    ...
                    Loader {
                        anchors.fill: parent
                        property bool active: root.effectiveCanSeek
