...
Item {
    ...
    property var searchIndex: [
        ...
        { pageIndex: 5, pageName: "Gowall", section: "Color Scheme Source", label: "BlueArchiveOS theme", targetLabel: "Color Scheme Source", keywords: ["gowall", "ba", "palette", "material you"] },
