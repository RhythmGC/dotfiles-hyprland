...
ContentPage {
    ...
    SettingsCardSection {
        ...
        title: Translation.tr("BlueArchiveOS Shell Updates")

        SettingsGroup {
            StyledText {
                Layout.fillWidth: true
                text: Translation.tr("Automatically checks the BlueArchiveOS git repository for new versions and shows a notification in the bar.")
            ...
            ConfigSpinBox {
                ...
                StyledToolTip {
                    text: Translation.tr("How often to check for BlueArchiveOS updates (in minutes). Default: 360 (6 hours)")
                }
            }
                ...
                RippleButton {
                    ...
                    onClicked: {
                        if (Config.options?.settingsUi?.overlayMode ?? false) {
                            ...
                            Quickshell.execDetached([Quickshell.shellPath("scripts/ba"), "shellUpdate", "open"])
                        }
                    }
