...
local qsIpcCall = "ba"
local qsIsAlive = "/usr/bin/pgrep -x qs"
...
hl.bind("CTRL + SUPER + T", hl.dsp.global("quickshell:coverflowSelectorToggle"),
...
--##! Session
hl.bind("SUPER + L", hl.dsp.exec_cmd(qsIpcCall .. " lock activate"), { description = "Session: Lock" })
