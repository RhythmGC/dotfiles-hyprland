...
hl.window_rule({match = {title = "^(Choose avatar image|Chọn ảnh đại diện)(.*)$" }, center = true})
hl.window_rule({match = {title = "^(Choose avatar image|Chọn ảnh đại diện)(.*)$" }, float = true})
hl.window_rule({match = {title = "^(Choose avatar image|Chọn ảnh đại diện)(.*)$" }, size = {"(monitor_w*0.60)", "(monitor_h*0.65)"} })
...
hl.window_rule({match = {title = "^(baOS Settings)$" },         float = true})
...
hl.layer_rule({ match = { namespace = "quickshell:idle" }, blur = true})
hl.layer_rule({ match = { namespace = "quickshell:idle" }, no_anim = true})
hl.layer_rule({ match = { namespace = "quickshell:idle" }, ignore_alpha = 0})
hl.layer_rule({ match = { namespace = "quickshell:idle" }, xray = false})
