...
-- Clipboard: history
exec_once("wl-paste --type text --watch bash -c 'cliphist store && qs -c ii ipc call cliphistService update'", "wl-paste")
exec_once("wl-paste --type image --watch bash -c 'cliphist store && qs -c ii ipc call cliphistService update'", "wl-paste")
