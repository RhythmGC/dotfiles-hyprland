...
Generated: 2026-05-28T01:22:19Z | Files: 500 | Described: 0/500
<!-- gsd:codebase-meta {"generatedAt":"2026-05-28T01:22:19Z","fingerprint":"82abc6843c4e435092c467fbaea38267d8b37d2d","fileCount":500,"truncated":true} -->
Note: Truncated to first 500 files. Run with higher --max-files to include all.

### .config/fastfetch/
- `.config/fastfetch/characters.jsonc`
- `.config/fastfetch/config.jsonc`
- `.config/fastfetch/fastfetch-random-char.sh`
- `.config/fastfetch/temp-config.jsonc`
...
- `.config/fish/completions/fnm.fish`

### .config/fish/conf.d/
- `.config/fish/conf.d/fish_frozen_key_bindings.fish`
- `.config/fish/conf.d/fish_frozen_key_bindings.fish.bak`
- `.config/fish/conf.d/fish_frozen_theme.fish`
- `.config/fish/conf.d/fish_frozen_theme.fish.bak`
...
### .config/hypr/hyprland/scripts/ai/
...
### .config/hypr/hyprland/shellOverrides/
...
### .config/matugen/templates/fuzzel/
- `.config/matugen/templates/fuzzel/fuzzel_theme.ini`

### .config/matugen/templates/gtk-3.0/
- `.config/matugen/templates/gtk-3.0/gtk.css`

### .config/matugen/templates/gtk-4.0/
...
### .config/quickshell/ii/modules/common/functions/
...
### .config/quickshell/ii/modules/common/models/
...
### .config/quickshell/ii/modules/common/models/gCloud/
...
### .config/quickshell/ii/modules/common/models/hyprland/
- `.config/quickshell/ii/modules/common/models/hyprland/HyprlandConfigOption.qml`

### .config/quickshell/ii/modules/common/models/quickToggles/
...
### .config/quickshell/ii/modules/common/panels/lock/
...
### .config/quickshell/ii/modules/common/panels/lock/pam/
- `.config/quickshell/ii/modules/common/panels/lock/pam/fprintd.conf`

### .config/quickshell/ii/modules/common/utils/
...
### .config/quickshell/ii/modules/common/widgets/shapes/geometry/
- `.config/quickshell/ii/modules/common/widgets/shapes/geometry/offset.js`

### .config/quickshell/ii/modules/common/widgets/shapes/graphics/
- `.config/quickshell/ii/modules/common/widgets/shapes/graphics/matrix.js`

### .config/quickshell/ii/modules/common/widgets/shapes/shapes/
...
### .config/quickshell/ii/modules/common/widgets/widgetCanvas/
...
### .config/quickshell/ii/modules/ii/background/widgets/
- `.config/quickshell/ii/modules/ii/background/widgets/AbstractBackgroundWidget.qml`

### .config/quickshell/ii/modules/ii/background/widgets/clock/
...
### .config/quickshell/ii/modules/ii/background/widgets/clock/dateIndicator/
...
### .config/quickshell/ii/modules/ii/background/widgets/clock/minuteMarks/
...
### .config/quickshell/ii/modules/ii/cheatsheet/
...
### .config/quickshell/ii/modules/ii/dock/
...
### .config/quickshell/ii/modules/ii/lock/
...
### .config/quickshell/ii/modules/ii/notificationPopup/
- `.config/quickshell/ii/modules/ii/notificationPopup/NotificationPopup.qml`

### .config/quickshell/ii/modules/ii/onScreenDisplay/
...
### .config/quickshell/ii/modules/ii/onScreenDisplay/indicators/
...
### .config/quickshell/ii/modules/ii/onScreenKeyboard/
...
### .config/quickshell/ii/modules/ii/overlay/
...
### .config/quickshell/ii/modules/ii/overlay/crosshair/
...
### .config/quickshell/ii/modules/ii/overlay/floatingImage/
- `.config/quickshell/ii/modules/ii/overlay/floatingImage/FloatingImage.qml`

### .config/quickshell/ii/modules/ii/overlay/fpsLimiter/
...
### .config/quickshell/ii/modules/ii/overlay/volumeMixer/
- `.config/quickshell/ii/modules/ii/overlay/volumeMixer/VolumeMixer.qml`

### .config/quickshell/ii/modules/ii/overview/
...
### .config/quickshell/ii/modules/ii/screenCorners/
- `.config/quickshell/ii/modules/ii/screenCorners/ScreenCorners.qml`

### .config/quickshell/ii/modules/ii/screenTranslator/
...
### .config/quickshell/ii/modules/ii/sessionScreen/
...
- `.config/quickshell/ii/modules/ii/sidebarLeft/WidgetsView.qml`

### .config/quickshell/ii/modules/ii/sidebarLeft/aiChat/
...
### .config/quickshell/ii/modules/ii/sidebarLeft/anime/
...
### .config/quickshell/ii/modules/ii/sidebarLeft/translator/
...
### .config/quickshell/ii/modules/ii/sidebarLeft/widgets/
- `.config/quickshell/ii/modules/ii/sidebarLeft/widgets/ClockCard.qml`
- `.config/quickshell/ii/modules/ii/sidebarLeft/widgets/ContextCard.qml`
- `.config/quickshell/ii/modules/ii/sidebarLeft/widgets/ControlsCard.qml`
- `.config/quickshell/ii/modules/ii/sidebarLeft/widgets/CryptoWidget.qml`
- `.config/quickshell/ii/modules/ii/sidebarLeft/widgets/DraggableWidgetContainer.qml`
- `.config/quickshell/ii/modules/ii/sidebarLeft/widgets/GlanceHeader.qml`
- `.config/quickshell/ii/modules/ii/sidebarLeft/widgets/MediaPlayerWidget.qml`
- `.config/quickshell/ii/modules/ii/sidebarLeft/widgets/NotesCard.qml`
- `.config/quickshell/ii/modules/ii/sidebarLeft/widgets/qmldir`
- `.config/quickshell/ii/modules/ii/sidebarLeft/widgets/QuickLaunch.qml`
- `.config/quickshell/ii/modules/ii/sidebarLeft/widgets/QuickNote.qml`
- `.config/quickshell/ii/modules/ii/sidebarLeft/widgets/QuickWallpaper.qml`
- `.config/quickshell/ii/modules/ii/sidebarLeft/widgets/StatusRings.qml`
- `.config/quickshell/ii/modules/ii/sidebarLeft/widgets/WeekStrip.qml`
- `.config/quickshell/ii/modules/ii/sidebarLeft/widgets/WidgetSettingsMenu.qml`
- `.config/quickshell/ii/modules/ii/sidebarLeft/widgets/YtMusicPlayerCard.qml`
- `.config/quickshell/ii/modules/ii/sidebarLeft/widgets/YtMusicTrackItem.qml`
...
### .config/quickshell/ii/modules/ii/sidebarRight/bluetoothDevices/
...
### .config/quickshell/ii/modules/ii/sidebarRight/calendar/
...
### .config/quickshell/ii/modules/ii/sidebarRight/nightLight/
- `.config/quickshell/ii/modules/ii/sidebarRight/nightLight/NightLightDialog.qml`

### .config/quickshell/ii/modules/ii/sidebarRight/notifications/
...
### .config/quickshell/ii/modules/ii/sidebarRight/pomodoro/
...
### .config/quickshell/ii/modules/ii/sidebarRight/quickToggles/
...
### .config/quickshell/ii/modules/ii/sidebarRight/quickToggles/androidStyle/
...
### .config/quickshell/ii/modules/ii/sidebarRight/quickToggles/classicStyle/
...
### .config/quickshell/ii/modules/ii/sidebarRight/todo/
...
### .config/quickshell/ii/modules/ii/sidebarRight/volumeMixer/
...
### .config/quickshell/ii/modules/ii/sidebarRight/wifiNetworks/
...
### .config/quickshell/ii/modules/ii/wallpaperSelector/
